...
\item Information on the accuracy of each product is given in
  Chapter~\ref{chap:Results}.  In the current version of this
  document, the numbers given are for the previous v4.2 dataset.
  Later versions of this document will include specific \thisv
  accuracy estimates.
