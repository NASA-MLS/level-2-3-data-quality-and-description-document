...
\begin{multicols}{2}
  ...
  quality of version~5.0\textit{x} Aura MLS Level~2 and Level~3 data.
  Secondly, to convey important information on how to read and
  interpret the data to the scientific community.
