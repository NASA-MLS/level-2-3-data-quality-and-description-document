...
\begin{multicols}{2}
  ...
  All the MLS \mbox{Level-2} and \mbox{Level-3} data described here can be obtained from the NASA Goddard Space Flight Center Earth Science Data and Information Services Center (GES-DISC, see \url{https://disc.gsfc.nasa.gov/}).  In addition, selected products are in the process of being made available on the Zenodo archive.

  \subsection*{What format are MLS data files in? }

  MLS \mbox{Level-2} data are in HDF-EOS version~5 format (see Section~\ref{sec:FilesAndFormats}, page~\pageref{sec:FilesAndFormats}). \mbox{Level-3} data are in netCDF~4 (see Section~\ref{sec:L3files}, page~\pageref{sec:L3files}).
