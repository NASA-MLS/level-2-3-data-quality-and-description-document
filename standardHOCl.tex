...
\begin{itemize}
  ...
  \item As discussed in Section~\ref{sec:HOClScreening}, biases in HOCl values are present at some levels when coincident measurements from the \mbox{190-GHz} radiometer are not available and \ch{H2O} \emph{a priori} information is used in the HOCl retrieval. Depending on the specific goals of any study based on these measurements, additional HOCl data quality filtering may be necessary for days when the \mbox{190-GHz} radiometer is off.
\end{itemize}
\begin{table}
