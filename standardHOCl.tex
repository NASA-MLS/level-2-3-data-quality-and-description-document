...
(a few \%).  The estimated precision values are essentially unchanged
from v3.3.
...
\item[Quality field:] \screeningrule{Only profiles with a value of the
    ...
    \emph{greater} than 1.2 should be used.}
...
photochemical model (Khosravi et al., 2013).  \mycomment {Nathaniel,
...
2.2 to 10   &  10 & 10    &   6  & 30\,--\,80 & $\sim$30\,--\,100 \\ 
