...
There were no significant algorithmic changes relating directly to HOCl for the \thisv retrievals. However, given the small level of HOCl spectral radiance signal, the retrieved HOCl abundances can be sensitive, indirectly, to even minor changes in the retrieval system, such as changes in temperature or tangent pressure. \mycomment{If the R2 cycling impacts HOCl, this would be hte place to discuss it}
...
\begin{itemize}
  ...
  \item Since May 2024, MLS water vapor (and other radiometer 2 products) were only retrieved for about a week during the middle of each month. Outside of these periods, poorer knowledge of the water vapor abundance (based on climatological values when the R2 bands are turned off) can lead to biases in the MLS retrievals of HOCl. Based on the MLS team's simulated HOCl retrievals for conditions without MLS-retrieved water vapor, the HOCl zonal means are expected to sometimes be biased by more than about 3\% (which can significantly alter long-term trend studies), especially for pressures between 4.6 and 10\,hPa, with some abundance biases larger than 5 to 10\%.  There should be essentially no impact on MLS HOCl from this issue at pressures less than 4.6 hPa. However, we generally recommend that long-term trend studies of this product only consider time periods when water vapor was retrieved by MLS rather than when radiometer 2 was turned off (to preserve its lifetime). We also note that time periods since May 2024 when the R2 radiometer is turned off can be intercompared.
\end{itemize}
