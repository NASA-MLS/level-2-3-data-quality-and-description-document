...
\item[End of Day:] The last four profiles of each day show greatly
  increased rates of large departure from \emph{a priori} and should not
  be used.
\end{description}
...
somewhat in \thisv.  A recommendation to discard the last 4 profiles
of each day has been added to recommended screening.
