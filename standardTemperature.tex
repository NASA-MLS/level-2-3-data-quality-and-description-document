...
that it did not close forword model and measured radiances as expected.
It had been hoped that better radiance closure would permit the use of
more radiances in the middle of the 118-GHz O\cs2 band, giving better
...
\item[Quality:] Only use profiles with \texttt{Quality}
    ...
    1.4\% of all data, and 4.8\% of profiles in the tropics.  At 215\,hPa
    in the tropics, the rejected profiles have mixing ratios that are,
    on average, 12\% higher than other tropical values and the
    occurrence rates of high outliers with mixing ratios greater than
    150\,ppbv is about twice that of the rest of the tropical ensemble.
    At 147\,hPa and 100\,hPa the rejected profiles are
...
and its variability averaged over 93 days processed with \thisv.
