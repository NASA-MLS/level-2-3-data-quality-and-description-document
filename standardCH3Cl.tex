...
(\textasciitilde0.1\,--\,0.4\,ppbv) negative bias at retrieval levels
...
stratospheric ClO\@.  Further refinements in the \thisv algorithms
...
\begin{figure}
\begin{center}
\includegraphics[angle=90,width=0.30\linewidth]{figures/InspectZMContour_CH3Cl--v4-1_CH3Cl--v3-3_2009m07_LatPress-All-noScreen-panel1}%
\includegraphics[angle=90,width=0.30\linewidth]{figures/InspectZMContour_CH3Cl--v4-1_CH3Cl--v3-3_2009m07_LatPress-All-noScreen-panel2}%
\includegraphics[angle=90,width=0.30\linewidth]{figures/InspectZMContour_CH3Cl--v4-1_CH3Cl--v3-3_2009m07_LatPress-All-noScreen-panel3}
\end{center}
...
Differences in the retrieved CH\cs3Cl abundances between the two
versions range from less than 10\,pptv at 68\,hPa and lower pressures
to \textasciitilde50\,pptv at 147\,hPa
(Figure~\ref{fig:zmcontourCH3Cl}), or typically within $\pm$10\%.
...
\textasciitilde2.7\,km), the vertical resolution of the \thisv
...
is \textasciitilde4\,--\,6\,km in most of the lower stratosphere,
degrading to \textasciitilde8\,--\,10\,km at and above (i.e., at
...
determined to be \textasciitilde600\,km at 147\,hPa,
\textasciitilde450\,--\,500\,km from 100 to 22\,hPa, and
\textasciitilde550\,--\,850\,km at and above 15\,hPa.  The cross-track
...
\begin{figure}
\centering\includegraphics[width=12.0cm]{figures/MLSascdsc_CH3Cl}
...
deviation values are \textasciitilde100\,pptv or less throughout the
vertical domain. Mean differences between paired crossing profiles are
\textasciitilde10\,pptv or less except at the lowest two levels, where
...
retrieval simulations; see \citet{SanteeEtal13ch3cl} for details of
...
different platforms (balloon-borne, aircraft, and satellite
instruments) were presented by \citet{SanteeEtal13ch3cl}.  Repeating
similar analyses for \thisv data will be the subject of future work.
