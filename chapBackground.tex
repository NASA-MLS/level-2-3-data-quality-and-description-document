...
\thisv testing, but is not invoked in the \thisv retrieval algorithms
...
for the older \prevv\ MLS products, updated from that described in the
...
\thisv\ and \prevv; however, we do plan to update these estimates for
\thisv\ and report findings in an updated version of this document.
