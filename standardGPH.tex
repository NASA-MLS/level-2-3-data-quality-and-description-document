...
and in concert with precisely measured differences in limb pointing, GPH
differences between pressure surfaces are inferred. Absolute pointing
cannot be inferred from radiometric information and must be provided for
each retrieved profile by the spacecraft orbit/attitude system and the
instrument scan model.  By convention, this additional degree of freedom
is taken to be the height of the 100-hPa reference level, but this
choice is arbitrary, as the reference is an additive offset to the
entire profile.
...
zero bias in the tropics.  Differences between the ascending and
descending parts of the orbits are consistent between \thisv and
\prevvSlahs, and are similar from year to year.  The annual cycle of
\thisv minus v03.30 100-hPa GPH is shown in
