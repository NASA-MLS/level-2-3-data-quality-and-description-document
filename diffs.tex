...
%DIF DEL previous-version.tex   Thu Dec  8 12:50:34 2016
%DIF ADD expanded.tex           Wed Feb  8 22:07:01 2017
%
% ---------------------------------------- Fundamentals
...
%
%DIF 139a139-140
% For avoiding problems with latexdiff %DIF > 
...
\DIFdelbegin %DIFDELCMD < \version{4.2x--2.0}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \version{4.2x--2.9a}
...
\item Information on the accuracy of each product is given in
  Chapter~\ref{chap:Results}.  In the \DIFdelbegin \DIFdel{current (early) version }\DIFdelend \DIFaddbegin \DIFadd{previous versions }\DIFaddend of this
  document, the numbers given \DIFdelbegin \DIFdel{are }\DIFdelend \DIFaddbegin \DIFadd{were }\DIFaddend for the previous v3.3 dataset.  This
  document \DIFdelbegin \DIFdel{will be }\DIFdelend \DIFaddbegin \DIFadd{has now been }\DIFaddend updated with the specific \thisv accuracy
  estimates\DIFdelbegin \DIFdel{at a later date}\DIFdelend .
...
\DIFaddbegin \section*{\DIFadd{Version 4.x-3.0}}
\DIFadd{The third released version of the document.  The changes mainly reflect 
...
\end{quote}
Work, including that described in this document, \DIFdelbegin \DIFdel{is underway to
re-validate }\DIFdelend \DIFaddbegin \DIFadd{has re-validated }\DIFaddend the
\thisv data, \DIFdelbegin \DIFdel{and to further establish }\DIFdelend \DIFaddbegin \DIFadd{establishing }\DIFaddend them as ``Stage~4'' validated, defined as:
\begin{quote}\itshape
...
\texttt{L2gpPrecision}, which describe the value and precision \DIFaddbegin \DIFadd{(reported
at 1$\sigma$) }\DIFaddend of the data, respectively.  Data points for which
\texttt{L2gpPrecision} is set negative or zero \emph{should not be
  used}, as this flags that the resulting precision is worse than 50\%
of the \emph{a priori} precision, indicating that instrument and/or the
algorithms have failed to provide enough useful information for that
point.  In addition to these fields, fields such as \texttt{latitude}
etc.\ describe geolocation information.  The field \texttt{time}
describes time, in the EOS standard manner, as the number of seconds
elapsed (including from five to nine subsequent leap seconds to date)
since midnight universal time on 1~January 1993.
...
\end{equation}
As of MLS version \thisv, the \DIFdelbegin \DIFdel{the }\DIFdelend \emph{a priori} profile for each MLS
...
quantification of these uncertainties \DIFdelbegin \DIFdel{was undertaken for the earlier
v2.2 MLS data and the results for each product reported in the relevant
}\DIFdelend \DIFaddbegin \DIFadd{has been performed for the }\thisv\DIFadd{\
MLS products, updated from that described in the MLS }\DIFaddend validation papers
(\DIFdelbegin \DIFdel{see the }\DIFdelend \DIFaddbegin \DIFadd{which were based on v2.2).  The }\DIFaddend individual sections of
Chapter~\ref{chap:Results} \DIFdelbegin \DIFdel{for references). In many cases these accuracy
estimates are expected to apply for }%DIFDELCMD < \thisv %%%
\DIFdel{also.
Chapter~\ref{chap:Results} reports the expected accuracy for each
product, taken and/or modified from the v2.2 estimates as appropriate}\DIFdelend \DIFaddbegin \DIFadd{detail the results of this quantification
product-by-product}\DIFaddend .
...
knowledge and/or design requirements.  \DIFaddbegin \DIFadd{Accordingly, the numbers reported
for each product in Chapter~\ref{chap:Results} reflect 2-$\sigma$
estimates of potential systematic error.
}\DIFaddend 
...
between \DIFdelbegin \DIFdel{5 to 30}\DIFdelend \DIFaddbegin \DIFadd{12 to 43}\DIFaddend \,pptv (typical BrO abundances range from 5 to 15\,pptv)
...
\DIFdelbegin \DIFdel{contain }\DIFdelend \DIFaddbegin \DIFadd{contains }\DIFaddend systematic biases and horizontal oscillations that present a
...
artifacts \citep{MillanEtal12}, and those products (\DIFdelbegin \DIFdel{currently }\DIFdelend based on
...
are expected to be applicable also to \thisv. The potential \DIFdelbegin \DIFdel{additive }\DIFdelend \DIFaddbegin \DIFadd{systematic
}\DIFaddend bias in MLS BrO measurements can be as high as about $\pm$\DIFdelbegin \DIFdel{30}\DIFdelend \DIFaddbegin \DIFadd{43}\DIFaddend \,ppt \DIFdelbegin \DIFdel{(\texttildelow400\%) }\DIFdelend at
10\,hPa, decreasing to about $\pm$\DIFdelbegin \DIFdel{6}\DIFdelend \DIFaddbegin \DIFadd{12}\DIFaddend \,pptv \DIFdelbegin \DIFdel{(50\%) }\DIFdelend at 3.2\,hPa. The \DIFdelbegin \DIFdel{potential scaling uncertainty over the pressure range of
10 to 3.2\,hPa is about $\pm$20\%. The additive }\DIFdelend \DIFaddbegin \DIFadd{systematic
}\DIFaddend bias is dramatically reduced by subtracting the nighttime signal from
the daytime signal.  Taking \DIFaddbegin \DIFadd{the }\DIFaddend day/night \DIFdelbegin \DIFdel{differences does not affect the
scaling uncertainty,
which remains at about }\DIFdelend \DIFaddbegin \DIFadd{difference reduces the
systematic biases to }\DIFaddend $\pm$\DIFdelbegin \DIFdel{20\%}\DIFdelend \DIFaddbegin \DIFadd{16\,pptv at 10\,hPa and to $\pm$9\,pptv at
3.2\,hPa}\DIFaddend .  If the MLS BrO data is used at 3.2 \DIFdelbegin \DIFdel{hP}\DIFdelend \DIFaddbegin \DIFadd{hPa}\DIFaddend , the day/night
...
Significant \DIFdelbegin \DIFdel{additive biases are seen }\DIFdelend \DIFaddbegin \DIFadd{biases exist }\DIFaddend in the BrO data, as discussed above. Day /
...
inferred from balloon-borne measurements of BrO\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{; }\DIFaddend good agreement is seen
\citep{KovalenkoEtal07}.


\begin{table}
\caption{Summary of the Aura MLS \thisv BrO product.}
%DIF >  \caption{Summary of the Aura MLS BrO product.}
\vspace{\tablecaptionsep}
\label{tab:BrOSummary}
\begin{minipage}{\linewidth}
\centering\DIFdelbeginFL %DIFDELCMD < \begin{tabular}{cccccl}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \begin{tabular}{ccccl}
\DIFaddendFL \toprule
...
\parbox[m]{4.5em}{\bfseries\centering \DIFdelbeginFL \DIFdelFL{Bias uncertainty}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Day/night difference accuracy}\DIFaddendFL \footnote{Because of large biases in
...
\DIFdelbeginFL \parbox[m]{5em}{%DIFDELCMD < \bfseries\centering %%%
\DIFdelFL{Scaling uncertainty}\footnote{\DIFdelFL{Based on modeled impacts
    of systematic errors}} %DIFAUXCMD
\addtocounter{footnote}{-1}%DIFAUXCMD
\DIFdelFL{/ \%}} %DIFAUXCMD
%DIFDELCMD < &
%DIFDELCMD < %%%
\DIFdelendFL \textbf{Comments} \\
\midrule
%
2.2\,hPa and less & -- & -- & -- & \DIFdelbeginFL \DIFdelFL{-- }%DIFDELCMD < & %%%
\DIFdelendFL Unsuitable for scientific use
  \\ \DIFdelbeginFL %DIFDELCMD < \addlinespace[2ex]
%DIFDELCMD < %%%
\DIFdelendFL %DIF > \addlinespace[2ex]
%
3.2\,hPa & 6 & $\pm$5 &$\pm$\DIFdelbeginFL \DIFdelFL{6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{9
}\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{$\pm$20
}%DIFDELCMD < & %%%
\DIFdelendFL \parbox[m]{10em}{\raggedright Need to
account for non-negligible night time BrO} \\ \addlinespace[2ex]
\DIFaddbeginFL 

\DIFaddendFL %
4.6 & 5.5 & $\pm$4 & $\pm$\DIFdelbeginFL \DIFdelFL{9  }%DIFDELCMD < & %%%
\DIFdelFL{$\pm$20 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{12  }\DIFaddendFL \\
6.8 & 5.5 & $\pm$4 & $\pm$\DIFdelbeginFL \DIFdelFL{20 }%DIFDELCMD < & %%%
\DIFdelFL{$\pm$20 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{14 }\DIFaddendFL \\ 
10  & 5.5 & $\pm$4 & $\pm$\DIFdelbeginFL \DIFdelFL{30 }%DIFDELCMD < & %%%
\DIFdelFL{$\pm$20 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{16 }\DIFaddendFL \\ 
150\,--\,15\,hPa   & -- & -- & -- & \DIFdelbeginFL \DIFdelFL{-- }%DIFDELCMD < & %%%
\DIFdelendFL Unsuitable for scientific use \\
1000\,--\,215\,hPa & -- & -- & -- & \DIFdelbeginFL \DIFdelFL{-- }%DIFDELCMD < & %%%
\DIFdelendFL Not retrieved \\
\bottomrule
\end{tabular}
\end{minipage}
\end{table}
...
measurements were assessed in detail by \citet{SanteeEtal13}.

As \DIFaddbegin \DIFadd{is the case }\DIFaddend for ClO, the standard CH\cs3Cl product is derived from
...
4.6\,hPa.  A summary of the \DIFdelbegin \DIFdel{precision and }\DIFdelend \DIFaddbegin \DIFadd{estimated precision, }\DIFaddend resolution (vertical
and horizontal)\DIFaddbegin \DIFadd{, and systematic uncertainty }\DIFaddend of the \thisv CH\cs3Cl
measurements as a function of altitude is given in
Table~\ref{tab:CH3ClSummary}.
\DIFdelbegin \DIFdel{More details on the quality of the MLS
}%DIFDELCMD < \thisv %%%
\DIFdel{CH}%DIFDELCMD < \cs3Cl %%%
\DIFdel{measurements are given below.
}\DIFdelend 
...
\caption{(left) Ensemble mean profiles for ascending (light red) and
  ...
  profiles averaged over \DIFaddbeginFL \DIFaddFL{several months of }\DIFaddendFL a representative year of
  data (\DIFdelbeginFL \DIFdelFL{2009}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2005}\DIFaddendFL ).  Symbols indicate MLS retrieval pressure levels.
...
the retrieval formulation and implementation) on the MLS \DIFdelbegin %DIFDELCMD < \prevv
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \thisv \DIFaddend CH\cs3Cl
measurements \DIFdelbegin \DIFdel{were }\DIFdelend \DIFaddbegin \DIFadd{have been }\DIFaddend quantified through a comprehensive set of
\DIFdelbegin \DIFdel{retrieval simulations}\DIFdelend \DIFaddbegin \DIFadd{retrievals of synthetic radiances}\DIFaddend ; see \citet{SanteeEtal13} for details
of \DIFdelbegin \DIFdel{how the analysis was conducted and the magnitude of }\DIFdelend \DIFaddbegin \DIFadd{a similar analysis conducted on MLS }\prevv \DIFadd{CH}\cs3Cl \DIFadd{data.  The
overall systematic uncertainty, or accuracy, is calculated by combining
(RSS) the contributions from both }\DIFaddend the expected biases and \DIFaddbegin \DIFadd{the }\DIFaddend additional
scatter each source of uncertainty may introduce into the data.  In
aggregate, \DIFdelbegin \DIFdel{systematic uncertainties were estimated to
induce in the }%DIFDELCMD < \prevv %%%
\DIFdel{CH}%DIFDELCMD < \cs3Cl %%%
\DIFdel{measurements biases of up to 45\% and
additional scatter of up to 25\% at and below (i.e., at pressures
greater than) 10\,hPa.  The }\DIFdelend \DIFaddbegin \DIFadd{the factors considered in these simulations are estimated to
give rise to }\DIFaddend total systematic uncertainty \DIFdelbegin \DIFdel{, calculated
by combining (RSS) the contributions from both the bias and the
scatter terms, is }\DIFdelend \DIFaddbegin \DIFadd{of }\DIFaddend approximately 30--45\% in
the \DIFaddbegin \DIFadd{MLS }\thisv \DIFadd{CH}\cs3Cl \DIFadd{data in the }\DIFaddend upper troposphere / lower
stratosphere \DIFdelbegin \DIFdel{.  Uncertainties are expected to be of similar
magnitude in }%DIFDELCMD < \thisv%%%
\DIFdel{, but a comprehensive }%DIFDELCMD < \thisv %%%
\DIFdel{systematic error
analysis will be the subject of future work.
}\DIFdelend \DIFaddbegin \DIFadd{(see Table~\ref{tab:CH3ClSummary}).
}\DIFaddend 
...
\item[Status flag:] \screeningrule{Only use profiles for which the
    \texttt{Status} field is zero.}  \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD <   %%%
\DIFdelend We recommend that all profiles with
...
\item[Quality:] \qualityrule{1.3} \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD <   %%%
\DIFdelend This threshold for \texttt{Quality}
...
\item[Convergence:] \convergencerule{1.05} \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD <   %%%
\DIFdelend On a typical day this
...
\parbox[m]{20mm}{\bfseries\DIFdelbeginFL %DIFDELCMD < \centering{Accuracy\\ / \%}%%%
\DIFdelendFL \DIFaddbeginFL \centering{Systematic\\ Uncertainty%
\footnote{Values should be interpreted as \mbox{2-$\sigma$} estimates
 of the probable magnitude.}\\ / \%}\DIFaddendFL } &
...
%
15\,--\,4.6    & 8\,--\,10 $\times$ 550\,--\,850     & $\pm$100     & \DIFdelbeginFL \DIFdelFL{30--75 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\pm$30\,--\,75 }\DIFaddendFL & \\
%
100\,--\,22    & \DIFdelbeginFL \DIFdelFL{4}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4.5}\DIFaddendFL \,--\,\DIFdelbeginFL \DIFdelFL{6  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{6.5  }\DIFaddendFL $\times$ 450\,--\,500 & $\pm$100     & \DIFdelbeginFL \DIFdelFL{30--45 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\pm$30\,--\,50 }\DIFaddendFL &  \\
%
147            & 4         $\times$ 600              & $\pm$100     & \DIFaddbeginFL \DIFaddFL{$\pm$}\DIFaddendFL 45     & \\
%
...
CH\cs3CN retrieval is largely unchanged in \thisv. \DIFdelbegin \DIFdel{Neither the }%DIFDELCMD < \prevv
%DIFDELCMD < %%%
\DIFdel{nor the }%DIFDELCMD < \thisv %%%
\DIFdel{CH}%DIFDELCMD < \cs3CN %%%
\DIFdel{data
have }\DIFdelend \DIFaddbegin \DIFadd{Although the data
have not }\DIFaddend been validated extensively\DIFdelbegin \DIFdel{at the time
of writing; such validation is planned for the future.  However}\DIFdelend , the \thisv CH\cs3CN \DIFdelbegin \DIFdel{data }\DIFdelend \DIFaddbegin \DIFadd{retrievals }\DIFaddend are
...
certain circumstances.  A summary of the estimated precision\DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend resolution
(vertical and horizontal)\DIFaddbegin \DIFadd{, and systematic uncertainty }\DIFaddend of the \thisv
...
The \DIFdelbegin \DIFdel{impact }\DIFdelend \DIFaddbegin \DIFadd{effects }\DIFaddend of various sources of systematic uncertainty \DIFdelbegin \DIFdel{has not yet
been quantified for }\DIFdelend \DIFaddbegin \DIFadd{(e.g.,
instrumental issues, spectroscopic uncertainty, and approximations in
the retrieval formulation and implementation) on the MLS }\thisv
\DIFaddend CH\cs3CN \DIFdelbegin \DIFdel{as it has for most other MLS products.  This work is planned as part of a dedicated validation exercise for
the }\DIFdelend \DIFaddbegin \DIFadd{measurements have been quantified through a comprehensive set
...
}\DIFaddend \thisv CH\cs3CN data \DIFdelbegin \DIFdel{.  However, preliminary comparisons with
}\DIFdelend \DIFaddbegin \DIFadd{(see Table~\ref{tab:CH3CNSummary}).
}

\subsection*{\DIFadd{Review of comparisons with other datasets}}

\DIFadd{Detailed quantification of differences from correlative data sets has
not been performed, but preliminary comparisons suggest that the MLS
CH}\cs3CN \DIFadd{measurements are biased substantially high in the UTLS
relative to airborne \mbox{%DIFAUXCMD
\citep{SinghEtal03}}%DIFAUXCMD
, balloon-borne
\mbox{%DIFAUXCMD
\citep{KleinbohlEtal05}}%DIFAUXCMD
, and \mbox{ACE-FTS} satellite
\mbox{%DIFAUXCMD
\citep{HarrisonAndBernath13} }%DIFAUXCMD
CH}\cs3CN \DIFadd{measurements, as do }\DIFaddend results from
a two-dimensional chemistry transport model and \DIFaddbegin \DIFadd{(noncoincident)
}\DIFaddend CH\cs3CN retrievals from the \DIFaddbegin \DIFadd{predecessor }\DIFaddend MLS instrument on the Upper
Atmosphere Research Satellite (UARS) \citep{LiveseyEtal01} \DIFdelbegin \DIFdel{indicate that the }%DIFDELCMD < \thisv %%%
\DIFdel{Aura
MLS CH}%DIFDELCMD < \cs3CN %%%
\DIFdel{mixing ratios are biased substantially high in the lower
stratosphere }\DIFdelend (not
...
\DIFdelbegin \subsection*{\DIFdel{Review of comparisons with other datasets}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Detailed comparisons with correlative data sets have not yet been
undertaken.  This work is planned as part of a dedicated validation
exercise for the }%DIFDELCMD < \thisv %%%
\DIFdel{CH}%DIFDELCMD < \cs3CN %%%
\DIFdel{data.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \subsection*{Data screening}
...
\parbox[m]{18mm}{\bfseries\centering{Precision%
    \footnote{Precision on individual profiles.} \\/ pptv}} &
\parbox[m]{20mm}{\bfseries\DIFdelbeginFL %DIFDELCMD < \centering{Accuracy\\ / pptv}%%%
\DIFdelendFL \DIFaddbeginFL \centering{Systematic\\ Uncertainty%
\footnote{Values should be interpreted as \mbox{2-$\sigma$} estimates
 of the probable magnitude.}\\ / \%}\DIFaddendFL } &
\parbox[m]{40mm}{\bfseries\centering{Known Artifacts\\ or Other Comments}} \\
...
%
1.0           & 6 $\times$ 800                 & $\pm$100 & \DIFdelbeginFL \DIFdelFL{TBD }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\pm$200 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Valid
except in winter polar regions }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Consult with MLS science team}\DIFaddendFL \\
%
10\,--\,1.5   & 7\,--\,8 $\times$ 400\,--\,700 & $\pm$50  & \DIFdelbeginFL \DIFdelFL{TBD }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\pm$100\,--\,200 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Valid
except in winter polar regions }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Consult with MLS science team}\DIFaddendFL \\
%
46\,--\,15    & 5\,--\,\DIFdelbeginFL \DIFdelFL{6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{6.5 }\DIFaddendFL $\times$ 400\,--\,\DIFdelbeginFL \DIFdelFL{700 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{500 }\DIFaddendFL & $\pm$50  & \DIFdelbeginFL \DIFdelFL{TBD }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\pm$100\,--\,200 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Valid
except in winter polar regions }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Consult with MLS science team}\DIFaddendFL \\
%
100\,--\,68   & \DIFdelbeginFL \DIFdelFL{5\,--\,6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{5.5 }\DIFaddendFL $\times$ \DIFdelbeginFL \DIFdelFL{400}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{550}\DIFaddendFL \,--\,700 & $\pm$50  & \DIFdelbeginFL \DIFdelFL{TBD }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\pm$100 }\DIFaddendFL & Consult with MLS science team\\
%
147           & 4 $\times$ 750                 & $\pm$100 & \DIFdelbeginFL \DIFdelFL{TBD }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\pm$200 }\DIFaddendFL & Consult with MLS science team\\
%
1000\,--\,215 & ---                            & ---      & --- & Not retrieved\\
%
\bottomrule
...
information.  CH\cs3OH is a new product in \thisv, and it has not \DIFdelbegin \DIFdel{yet
}\DIFdelend been
fully validated.  Thus the scientific utility of the \thisv MLS
CH\cs3OH measurements remains to be determined.  \DIFaddbegin \DIFadd{A summary of the
estimated precision, resolution (vertical and horizontal), and
systematic uncertainty of the }\thisv \DIFadd{CH}\cs3OH \DIFadd{measurements as a
...
instrumental issues, spectroscopic uncertainty, and approximations in
the retrieval formulation and implementation) on the MLS }\thisv
\DIFaddend CH\cs3OH \DIFdelbegin \DIFdel{as it has for most other MLS products.  This work is planned as part of a dedicated validation exercise for
the }\DIFdelend \DIFaddbegin \DIFadd{measurements have been quantified through a comprehensive set
of retrievals of synthetic radiances.  The overall systematic
uncertainty, or accuracy, is calculated by combining (RSS) the
contributions from both the expected biases and the additional scatter
...
}\DIFaddend \thisv CH\cs3OH data \DIFaddbegin \DIFadd{(see Table~\ref{tab:CH3OHSummary})}\DIFaddend .

\subsection*{Review of comparisons with other datasets}

Detailed comparisons with correlative data sets have not \DIFdelbegin \DIFdel{yet been
undertaken.  This work is planned as part of a dedicated validation
exercise for the }%DIFDELCMD < \thisv %%%
\DIFdel{CH}%DIFDELCMD < \cs3OH %%%
\DIFdel{data }\DIFdelend \DIFaddbegin \DIFadd{been
...
147\,hPa (not shown)}\DIFaddend .

\subsection*{Data screening}
\label{sec:CH3OHScreening}
\begin{description}
\item[Do not use:] \DIFdelbegin \DIFdel{Until more comprehensive validation studies have
  been done, the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend \thisv CH\cs3OH data should only be used in
...
\item A complete assessment of artifacts in the \thisv CH\cs3OH
  measurements has not \DIFdelbegin \DIFdel{yet }\DIFdelend been performed, but it is known that zonal mean
  mixing ratios are negative everywhere at retrieval pressures less
  than \DIFdelbegin \DIFdel{100}\DIFdelend \DIFaddbegin \DIFadd{or equal to 68}\DIFaddend \,hPa, as well as at middle and high latitudes at
  100\,hPa.
\end{itemize}
...
\parbox[m]{20mm}{\bfseries\DIFdelbeginFL %DIFDELCMD < \centering{Accuracy\\ / ppbv}%%%
\DIFdelendFL \DIFaddbeginFL \centering{Systematic\\ Uncertainty%
\footnote{Values should be interpreted as \mbox{2-$\sigma$} estimates
 of the probable magnitude.}\\ / \%}\DIFaddendFL } &
\parbox[m]{40mm}{\bfseries\centering{Known Artifacts\\ or Other Comments}} \\
...
%
100            & 5         $\times$ 350          & $\pm$1   & \DIFdelbeginFL \DIFdelFL{TBD  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\pm$100  }\DIFaddendFL &
Consult with MLS Science Team \\
%
147            & \DIFdelbeginFL \DIFdelFL{4         }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3         }\DIFaddendFL $\times$ 150          & $\pm$1   & \DIFdelbeginFL \DIFdelFL{TBD  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\pm$250  }\DIFaddendFL &
Consult with MLS Science Team \\
%
1000\,--\,215  & ---                             & ---      & ---  & Not retrieved\\
%
...
summary of the \DIFdelbegin \DIFdel{precision and }\DIFdelend \DIFaddbegin \DIFadd{estimated precision, }\DIFaddend resolution (vertical and
horizontal)\DIFaddbegin \DIFadd{, and systematic uncertainty }\DIFaddend of the \thisv ClO measurements
as a function of altitude is given in Table~\ref{tab:ClOSummary}.
\DIFdelbegin \DIFdel{The impact of various sources of
systematic uncertainty on the ClO retrievals was quantified in detail
for v2.2 data \mbox{%DIFAUXCMD
\citep{SanteeEtal08clo}}%DIFAUXCMD
; Table~\ref{tab:ClOSummary} also
...
most of the sources of uncertainty affect }%DIFDELCMD < \thisv %%%
\DIFdel{retrievals in a
...
resolution, and accuracy of the MLS }%DIFDELCMD < \thisv %%%
\DIFdel{ClO measurements are given
below.
}\DIFdelend 
...
\begin{figure}
\centering\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=8.4cm]{figures/ComparePrecision2Panel-clo}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=8.4cm]{figures/ComparePrecision2Panel-ClO}
\DIFaddendFL \caption{Precision of the (left) \thisv and (right) \prevv MLS ClO
...
The effects of various sources of systematic uncertainty (e.g.,
instrumental issues, spectroscopic uncertainty, and approximations in
the retrieval formulation and implementation) on the MLS \DIFdelbegin \DIFdel{v2.2 ClO
measurements were }\DIFdelend \DIFaddbegin \thisv \DIFadd{ClO
measurements have been }\DIFaddend quantified through a comprehensive set of
\DIFdelbegin \DIFdel{retrieval
simulations}\DIFdelend \DIFaddbegin \DIFadd{retrievals of synthetic radiances}\DIFaddend ; see \citet{SanteeEtal08clo} for
details of \DIFdelbegin \DIFdel{how the
analysis was conducted and the magnitude of }\DIFdelend \DIFaddbegin \DIFadd{a similar analysis conducted on MLS v2.2 ClO data.  The
overall systematic uncertainty, or accuracy, is calculated by
combining (RSS) the contributions from both }\DIFaddend the expected biases \DIFdelbegin \DIFdel{,
additional scatter , and possible scaling errors }\DIFdelend \DIFaddbegin \DIFadd{and
the additional scatter }\DIFaddend each source of uncertainty may introduce into
the data.  In aggregate, \DIFdelbegin \DIFdel{systematic
uncertainties were estimated to induce in the v2.2 ClO measurements
biases of \mbox{\texttildelow$\pm$0.1\,ppbv} from 100 to 32}\DIFdelend \DIFaddbegin \DIFadd{the factors considered in these simulations
are estimated to give rise to a total systematic uncertainty ranging
from approximately 0.02 to 0.4}\DIFaddend \,\DIFdelbegin \DIFdel{hPa and
less than $\pm$0.05\,ppbvabove 22\,hPa and multiplicative errors of
\mbox{\texttildelow$\pm$5--20\%} throughout the stratosphere.
Uncertainties are expected to be of similar magnitude in }%DIFDELCMD < \thisv%%%
\DIFdel{, but a
comprehensive }\DIFdelend \DIFaddbegin \DIFadd{ppbv, depending on the level, in the
MLS }\DIFaddend \thisv \DIFdelbegin \DIFdel{systematic error analysis will be the
subject of
future work}\DIFdelend \DIFaddbegin \DIFadd{ClO data (see Table~\ref{tab:ClOSummary})}\DIFaddend .
...
\begin{figure}
\centering\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth,clip=true,trim=0cm 1.5cm 0cm 1.5cm]{figures/plotBiasV4ByMonth}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth,clip=true,trim=0cm 1.5cm 0cm 1.5cm]{figures/plotBiasV4ByMonth-Clim}
\DIFaddendFL \caption{Estimates of the bias in MLS \thisv ClO data in
  5{\degsym}-wide geographic latitude bands on the 147, 100, \DIFdelbeginFL \DIFdelFL{and }\DIFdelendFL 68\DIFaddbeginFL \DIFaddFL{, and
  46}\DIFaddendFL \,hPa MLS retrieval pressure surfaces (see legend).  Each panel
  shows monthly zonal means of \thisv MLS nighttime (solar zenith
  angle (SZA) $>$ 100{\degsym}) ClO measurements \DIFdelbeginFL \DIFdelFL{from 2009 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{averaged over a
  \mbox{12-yr} period }\DIFaddendFL (\DIFaddbeginFL \DIFaddFL{2005--2016, }\DIFaddendFL filled circles).  The grey line
  marks the zero level.  The colored solid lines denote the global
  mean bias estimate at each level\DIFdelbeginFL \DIFdelFL{for 2009.  The }%DIFDELCMD < \thisv %%%
\DIFdelFL{results are compared
  against corresponding }%DIFDELCMD < \prevv %%%
\DIFdelFL{data (open circles and dotted lines)}\DIFdelendFL .  To ensure that ClO was not
...
To investigate the magnitude of \DIFaddbegin \DIFadd{and temporal variations in }\DIFaddend the bias in
the \thisv MLS ClO data\DIFdelbegin \DIFdel{and
the temporal variations in it}\DIFdelend , we show in Figure~\ref{fig:cloBiasByMonth}
monthly zonal means of MLS nighttime ClO measurements \DIFdelbegin \DIFdel{from 2009 }\DIFdelend for pressure
levels \DIFdelbegin \DIFdel{147--68}\DIFdelend \DIFaddbegin \DIFadd{147--46}\DIFaddend \,hPa.  \DIFdelbegin \DIFdel{For each
panel , }\DIFdelend \DIFaddbegin \DIFadd{Each panel represents }\DIFaddend a calendar month\DIFdelbegin \DIFdel{of data
is }\DIFdelend \DIFaddbegin \DIFadd{; data
taken during that month over the course of the Aura mission to date
(2005--2016) have been }\DIFaddend binned and averaged in 5{\degsym}-wide latitude
bands between $\pm$85{\degsym}. Figure~\ref{fig:cloBiasByPress} is a
similar plot \DIFdelbegin \DIFdel{, }\DIFdelend but encompasses all of the MLS nighttime ClO data \DIFdelbegin \DIFdel{from 2009 }\DIFdelend for
pressure levels 147--10\,hPa.  \DIFaddbegin \DIFadd{Although
...
\texttildelow0.01\,ppbv at 68\,hPa) at $\pm$50}{\degsym} \DIFadd{(the highest
...
bias estimates.  }\DIFaddend To guide the eye, the global mean \DIFdelbegin \DIFdel{value of the bias
from
2009 }\DIFdelend \DIFaddbegin \DIFadd{climatological bias
value }\DIFaddend is indicated for each level (colored solid lines) in both
figures.  \DIFdelbegin \DIFdel{In Figure~\ref{fig:cloBiasByMonth}, the corresponding }%DIFDELCMD < \prevv %%%
\DIFdel{data are
also shown for comparison.  }\DIFdelend As discussed above, the magnitude, and at 147\,hPa even the
sign, of the bias varies with latitude, and
Figures~\ref{fig:cloBiasByMonth} and \ref{fig:cloBiasByPress}
\DIFdelbegin \DIFdel{make clear
that application of a constant bias correction for all latitudes is not
appropriate.  However, although }\DIFdelend \DIFaddbegin \DIFadd{underscore the necessity of applying latitudinally and altitudinally
varying bias corrections.  Given the degree of seasonal variability
seen in }\DIFaddend Figure~\ref{fig:cloBiasByMonth}\DIFdelbegin \DIFdel{reveals
significant month-to-month variability, for most studies a
}\DIFdelend \DIFaddbegin \DIFadd{, monthly varying bias
...
success.  Consequently, we report }\DIFaddend time-invariant \DIFdelbegin \DIFdel{latitudinally varying bias
correction is
adequate.  An
ASCII file containing the }\DIFdelend \DIFaddbegin \DIFadd{but }\DIFaddend altitude- and
latitude-dependent \thisv ClO bias \DIFdelbegin \DIFdel{correction values will be made }\DIFdelend \DIFaddbegin \DIFadd{corrections, which are adequate for
most studies.  An ASCII file containing the estimated bias values is
}\DIFaddend available from the MLS web site\DIFdelbegin \DIFdel{once
more data from the mission have been reprocessed to }%DIFDELCMD < \thisv%%%
\DIFdelend .

\begin{figure}
  \centering\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=8.4cm]{figures/plotBiasV4}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=8.4cm,clip=true, trim=1.8cm
    12.5cm 11.0cm 7.5cm]{figures/plotBiasV4-Clim}
\DIFaddendFL \caption{Estimates of the bias in MLS \thisv ClO data in
  5{\degsym}-wide geographic latitude bands on MLS retrieval pressure
  surfaces from 147 to 10\,hPa (see legend) calculated \DIFdelbeginFL \DIFdelFL{for data from
  2009.  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{over a
  \mbox{12-yr} period (2005--2016).  }\DIFaddendFL To ensure that ClO was not
  enhanced, consideration was restricted to latitudes equatorward of
  50{\degsym}S for the days between 1~May and 1~November and to
  latitudes equatorward of 50{\degsym}N for the days between
  1~December and 1~April.  The colored solid lines denote the global
  mean bias estimate at each level\DIFdelbeginFL \DIFdelFL{for 2009.  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{.  }\DIFaddendFL The large positive bias at low
...
\DIFdelbegin \DIFdel{Repeating similar analyses for }%DIFDELCMD < \thisv
%DIFDELCMD < %%%
\DIFdel{data will be the subject of future work.
}\DIFdelend 
...
\item Significant biases are present in both daytime and nighttime
  ...
  file \DIFdelbegin \DIFdel{to be made }\DIFdelend available from the MLS web site\DIFdelbegin \DIFdel{once more data from
  the mission have been reprocessed to }%DIFDELCMD < \thisv%%%
\DIFdelend .
\end{itemize}
...
%DIFDELCMD < \caption{Summary of Aura MLS \thisv ClO Characteristics}\vspace{0.5ex}
%DIFDELCMD < \label{tab:ClOSummary}
%DIFDELCMD < \begin{minipage}{\linewidth}\small
%DIFDELCMD < \renewcommand{\thefootnote}{\thempfootnote}
%DIFDELCMD < \centering\begin{tabular}{cccccl}
%DIFDELCMD < \toprule
%DIFDELCMD < \parbox[m]{18mm}{\bfseries\centering{Pressure\\ / hPa}} &
%DIFDELCMD < \parbox[m]{24mm}{\bfseries\centering{Resolution\\ V $\times$ H%
%DIFDELCMD < \footnote{Vertical and Horizontal resolution in along-track direction.} \\ / km}} &
%DIFDELCMD < \parbox[m]{17mm}{\bfseries\centering{Precision%
%DIFDELCMD < \footnote{Precision on individual profiles, determined from observed
%DIFDELCMD <  scatter in nighttime (descending) data in a region of minimal atmospheric
%DIFDELCMD <  variability.} \\/ ppbv}} &
%DIFDELCMD < \parbox[m]{19mm}{\bfseries\centering{Bias\\uncertainty%
%DIFDELCMD <     \footnote{Values should be interpreted as \mbox{$2\sigma$}
%DIFDELCMD <       estimates of the probable magnitude and, at the higher
%DIFDELCMD <       pressures, are the uncertainties after subtraction of the known
%DIFDELCMD <       bias.}\gdef\fnTwoSigma{\value{mpfootnote}}\\ / ppbv}} &
%DIFDELCMD < \parbox[m]{19mm}{\bfseries\centering{Scaling\\uncertainty\footnotemark[\fnTwoSigma]\\/ \%}} &
%DIFDELCMD < \parbox[m]{40mm}{\bfseries\centering{Known Artifacts\\ or Other Comments}} \\
%DIFDELCMD < %
%DIFDELCMD < \midrule
%DIFDELCMD < %
%DIFDELCMD < 0.68--0.001 & ---   & ---  & ---  & --- & Unsuitable for scientific use\\
%DIFDELCMD < %
%DIFDELCMD < 1.0         & 3        $\times$ 500      & $\pm$0.3 & $\pm$0.05 & $\pm$15\% & \\
%DIFDELCMD < %
%DIFDELCMD < 15--1.5     & 3.5--4   $\times$ 250--400 & $\pm$0.1 & $\pm$0.05 & $\pm$5--15\% & \\
%DIFDELCMD < %
%DIFDELCMD < 46--22      & 3        $\times$ 300--400 & $\pm$0.1 & $\pm$0.1  & $\pm$20\% & \\
%DIFDELCMD < %
%DIFDELCMD < 68          & 3        $\times$ 450      & $\pm$0.1 & $\pm$0.1  & $\pm$20\% &
%DIFDELCMD < Latitude-dependent bias\footnote{Correct for the bias by subtracting
%DIFDELCMD <   from the individual measurements at this level the
%DIFDELCMD <   latitude-dependent bias estimates given in the ASCII file
%DIFDELCMD <   to be made available from the MLS web
%DIFDELCMD <   site once more data from the mission have been reprocessed to \thisv.}\gdef\fnDirect{\value{mpfootnote}} \\
%DIFDELCMD < %
%DIFDELCMD < 100         & 3        $\times$ 500      & $\pm$0.1 & $\pm$0.1  & $\pm$20\% &
%DIFDELCMD < Latitude-dependent bias\footnotemark[\fnDirect] \\
%DIFDELCMD < %
%DIFDELCMD < 147         & 4.5      $\times$ 600      & $\pm$0.3 & $\pm$0.2  & $\pm$40\% &
%DIFDELCMD < Latitude-dependent bias\footnotemark[\fnDirect] \\
%DIFDELCMD < %
%DIFDELCMD < 1000--215   & ---   & ---   & --- & --- & Not retrieved\\
%DIFDELCMD < %
...
%
 15--1.5     & 3.5\,--\,4   $\times$ 250\,--\,400 & $\pm$0.1 & $\pm$0.02\,--\,0.03 & \\
%
22          & 3        $\times$ 300--400 & $\pm$0.1 & $\pm$0.05  & \\
%
...
bias\footnote{Correct for the bias by subtracting from the individual
  measurements at this level the latitude-dependent bias estimates given
  in the ASCII file
  available from the MLS website}\gdef\fnDirect{\value{mpfootnote}} \\
%
100         & 3        $\times$ 500      & $\pm$0.1 & $\pm$0.25  & 
Latitude-dependent bias\footnotemark[\fnDirect] \\
%
147         & 4.5      $\times$ 600      & $\pm$0.3 & $\pm$0.4  & 
Latitude-dependent bias\footnotemark[\fnDirect] \\
%
1000--215   & ---   & ---   & --- &  Not retrieved\\
%
...
channels considered in the retrieval. \DIFaddbegin \DIFadd{Tropospheric (215\,--\,100\,hPa) 
accuracies in Table~\ref{tab:COSummary} are  2-$\sigma$ estimates 
obtained by propagating parameter uncertainties through 
a model of the measurement system.
}\DIFaddend 
...
\item There is a tendency for negative values to occur at the level
  ...
  middle atmosphere.
\item Upper-tropospheric \thisv CO retrieved values still show some anomalous 
sensitivity to thick clouds associated with deep convection.  
The screening procedure based upon \texttt{Quality} and \texttt{Convergence} 
that is described above is generally effective in removing these artifacts\DIFaddbegin \DIFadd{.
...
\textbf{Resolution / km} & 
\textbf{Precision} / &
\textbf{\DIFdelbeginFL \DIFdelFL{Systematic}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Accuracy}\DIFaddendFL } &  
\textbf{Comment} \\
\textbf{/ hPa} &
\textbf{Vert $\times$ Horiz.} &
\textbf{ppbv} \DIFdelbeginFL %DIFDELCMD < &
%DIFDELCMD < %%%
\textbf{\DIFdelFL{Uncertainty}} %DIFAUXCMD
\DIFdelendFL \\
\midrule
$<0.001$  &    ---        &   ---   &    ---      & Not retrieved\\
0.0022-0.001  & ---       &   ---   &    ---    & Unsuitable
for scientific use \\
0.0046 &   6.2   $\times$ 200 &  \DIFdelbeginFL \DIFdelFL{11000  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{6000  }\DIFaddendFL &   $+$20\% to $+$50\%     &  \\
0.01   &   5.9   $\times$ 200 &  \DIFdelbeginFL \DIFdelFL{4000   }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3400   }\DIFaddendFL &   $+$20\% to $+$50\%  &  \\
0.046  &   5.9   $\times$ 200 &  \DIFdelbeginFL \DIFdelFL{1200   }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{1000   }\DIFaddendFL &    $+$20\% to $+$50\%    &  \\
0.14   &   3.8   $\times$ 200 &  \DIFdelbeginFL \DIFdelFL{700    }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{640    }\DIFaddendFL &    $+$20\% to $+$50\%    &  \\
1      &   4.1   $\times$ 250 &  \DIFdelbeginFL \DIFdelFL{130    }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{120    }\DIFaddendFL &    $+$20\% to $+$50\%  &  \\
10     &   5.0   $\times$ 440 &  16     &    $\pm 10$\%    &  \\
31     &   4.9   $\times$ 400 &   9     &    $-$70\% to $-$50\%    &  \\
100    &   4.9   $\times$ 450 &  14     & $\pm$20\,ppbv and $\pm$\DIFdelbeginFL \DIFdelFL{30}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{24}\DIFaddendFL \% & \\
147    &   5.1   $\times$ 570 &  \DIFdelbeginFL \DIFdelFL{15     }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{16     }\DIFaddendFL & $\pm$30\,ppbv and $\pm$30\% & \\
215    &   5.4   $\times$ 690 &  19     & $\pm$\DIFdelbeginFL \DIFdelFL{30}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{40}\DIFaddendFL \,ppbv and $\pm$30\% \\
...
\DIFdelbegin \DIFdel{As of the drafting of this document, the entire MLS data record has not
been reprocessed with }%DIFDELCMD < \thisv %%%
\DIFdel{algorithms, but 11 years of Januarys have
been completed and the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend monthly-averaged differences between MLS \thisv 100-hPa GPH and
GEOS-5.9 100-hPa GPH \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{for 11 years of Januarys are }\DIFaddend shown in
...
if a measurement is repeated.  The retrieval \DIFdelbegin \DIFdel{software returns }\DIFdelend \DIFaddbegin \DIFadd{algorithms produce }\DIFaddend an
estimate of GPH precision only for the 100\,hPa reference level, as this
is the only element included in the MLS ``state vector.''  \DIFdelbegin \DIFdel{GPH precision }\DIFdelend \DIFaddbegin \DIFadd{Precisions
...
GPH precisions }\DIFaddend at other standard-product profile levels (summarized in
column~2 of Table~\ref{tab:GPHSummary}) \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{are }\DIFaddend calculated from the GPH
precision at the reference level and the profile of temperature
precisions\DIFdelbegin \DIFdel{.  Calculated
precision values are \texttildelow35}\DIFdelend \DIFaddbegin \DIFadd{, but values in the table are inflated somewhat from those in
the L2GP files in the troposphere and stratosphere. Estimated precisions
remain at 20}\DIFaddend \,\DIFdelbegin \DIFdel{m from 261}\DIFdelend \DIFaddbegin \DIFadd{--}\DIFaddend \,\DIFdelbegin \DIFdel{hPa to 100}\DIFdelend \DIFaddbegin \DIFadd{25}\DIFaddend \,\DIFdelbegin \DIFdel{hPa,
\texttildelow45\,}\DIFdelend m \DIFdelbegin \DIFdel{at }\DIFdelend \DIFaddbegin \DIFadd{up to }\DIFaddend 1\,hPa \DIFdelbegin \DIFdel{, \texttildelow110}\DIFdelend \DIFaddbegin \DIFadd{and degrade to 110}\DIFaddend \,m at \DIFdelbegin \DIFdel{0.001}\DIFdelend \DIFaddbegin \DIFadd{0.01}\DIFaddend \,hPa.
...
data assimilation system (GEOS-5) \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{ReineckerEtal07}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{RieneckerEtal07}}%DIFAUXCMD
}\DIFaddend , used in the
...
\begin{table}
\DIFaddbeginFL \caption{\DIFaddFL{Summary of MLS GPH product.}}
\DIFaddendFL \label{tab:GPHSummary}
\begin{minipage}{\linewidth}
\centering\begin{tabular}{ccccl}
\toprule
\textbf{Region} & 
...
\parbox[m]{20mm}{\centering\DIFdelbeginFL \textbf{\DIFdelFL{Observed bias}%DIFDELCMD < \\%%%
\DIFdelFL{uncertainty}%DIFDELCMD < \\ %%%
\DIFdelFL{/ m}}%DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Observed}\\\DIFaddFL{accuracy}\\ \DIFaddFL{/ m}}\DIFaddendFL } &
\textbf{Comments} \\
\midrule
$<$0.001\,hPa & --- & --- & --- & Unsuitable for scientific use \\
0.001\,hPa          & 10--13 $\times$ 220  & $\pm$\DIFdelbeginFL \DIFdelFL{110 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{160 }\DIFaddendFL & $-$450 & \\
0.01\,hPa           & 8--12 $\times$ 185  & $\pm$\DIFdelbeginFL \DIFdelFL{85   }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{110   }\DIFaddendFL & $-$100 & \\
0.1\,hPa            & 6 $\times$ 165   & $\pm$\DIFdelbeginFL \DIFdelFL{60   }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{45   }\DIFaddendFL &  0  & \\
1\,hPa              & 7 $\times$ 165   & $\pm$\DIFdelbeginFL \DIFdelFL{45   }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{25   }\DIFaddendFL & 100 & \\
10\,hPa             & 4.3 $\times$ 165 & $\pm$\DIFdelbeginFL \DIFdelFL{35   }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{20   }\DIFaddendFL & 100 & \\
100\,hPa            & 5.2 $\times$ 165 & $\pm$\DIFdelbeginFL \DIFdelFL{30   }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{20   }\DIFaddendFL & 150 & \\
261\,hPa            & 5.3 $\times$ 170 & $\pm$\DIFdelbeginFL \DIFdelFL{35   }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{20   }\DIFaddendFL & 150 & \\
...
\thisv H\cs2O data. For pressures \DIFdelbegin \DIFdel{$\geq100\,\text{hPa}$}\DIFdelend \DIFaddbegin \DIFadd{$\geq100$\,hPa}\DIFaddend , the precisions
...
\citep{ReadEtal07}.  For pressures \DIFdelbegin \DIFdel{$\leq$83}\DIFdelend \DIFaddbegin \DIFadd{$\leq83$}\DIFaddend \,hPa the precisions are the
...
with validated instruments and a \DIFaddbegin \DIFadd{full }\DIFaddend systematic error analysis
performed on the MLS measurement system \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{ReadEtal07} }%DIFAUXCMD
and \mbox{%DIFAUXCMD
\citep{LambertEtal07}
}%DIFAUXCMD
(performed }\DIFdelend \DIFaddbegin \DIFadd{as described (}\DIFaddend for v2, but \DIFdelbegin \DIFdel{expected to be insignificantly different for H}%DIFDELCMD < \cs2O %%%
\DIFdel{in }\DIFdelend \DIFaddbegin \DIFadd{the
same approach has been used for }\DIFaddend \thisv\DIFdelbegin \DIFdel{because the relevant aspects of the instrument's
calibration and
spectroscopic uncertainties and the retrieval set up
have not changed. A systematic errors study will be performed on v4
soon).  }\DIFdelend \DIFaddbegin \DIFadd{) in \mbox{%DIFAUXCMD
\citet{ReadEtal07} }%DIFAUXCMD
and
\mbox{%DIFAUXCMD
\citet{LambertEtal07}}%DIFAUXCMD
. }\DIFaddend For pressures between 316\,--\,178\,hPa,
\DIFdelbegin \DIFdel{Comparisons }\DIFdelend \DIFaddbegin \DIFadd{comparisons }\DIFaddend between AIRS v6 and MLS \thisv show \DIFdelbegin \DIFdel{$<$20}\DIFdelend \DIFaddbegin \DIFadd{$<20$}\DIFaddend \% agreement in the
zonal mean (MLS usually drier for low concentrations and wetter for high
concentrations) equatorward of 40\degsym\ with MLS having large dry
...
\DIFdelbegin \subsection*{\DIFdel{Data screening}}
%DIFAUXCMD
%DIFDELCMD < \label{sec:H2OScreening}
%DIFDELCMD < \begin{description}
%DIFDELCMD < \item[Pressure range:] \screeningrule{316\,--\,0.002\,hPa.}
%DIFDELCMD <   %%%
\DIFdel{\standardrangestatement
}%DIFDELCMD < \standardprecisionrule
%DIFDELCMD < \evenstatusrule
%DIFDELCMD < \item[Clouds:] %%%
\DIFdel{Ignore status bit 16 (high cloud) or bit 32 (low cloud) set
indicating the presence of clouds. See artifacts for more details.
}%DIFDELCMD < \item[Quality field:] \screeningrule{Only profiles with a value of the
%DIFDELCMD <     \texttt{Quality} \emph{greater} than 1.45 should be used in
%DIFDELCMD <     scientific studies.}  %%%
\DIFdel{This recommendation is for scientific studies
  ...
  the product and much lower }\texttt{\DIFdel{Quality}} %DIFAUXCMD
\DIFdel{values can be
  ...
  January--February having a 2\% higher yield at }\texttt{\DIFdel{Quality}}%DIFAUXCMD
\DIFdel{$ =
  1.45$.  The recommended }\texttt{\DIFdel{Quality}} %DIFAUXCMD
\DIFdel{threshold value is where the
  ...
  }\texttt{\DIFdel{Quality}} %DIFAUXCMD
\DIFdel{field for ``process'' studies or situations where a
...
\DIFdel{less than that recommended to ensure that the product
  is trustworthy.
}\DIFdelend \DIFaddbegin \DIFadd{Please note the discussion of a potential drift in the MLS lower
stratospheric water vapor measurements discussed below.
}\DIFaddend 

\DIFdelbegin %DIFDELCMD < \item[Convergence field:] \screeningrule{Only profiles with a value of
%DIFDELCMD <     the \texttt{Convergence} \emph{less} than 2.0 should be used in
%DIFDELCMD <     scientific studies.}
%DIFDELCMD < \end{description}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsection*{\DIFadd{A note about the water vapor averaging kernels}}
\DIFaddend 

\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD < \begin{center}
%DIFDELCMD < \includegraphics[width=0.8\linewidth]{figures/h2o_data_yields}
%DIFDELCMD < \end{center}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Percentage of data having a quality greater than that indicated
 on the x-axis for }%DIFDELCMD < \thisv %%%
\DIFdelFL{data processed for all of 2005.}}
%DIFAUXCMD
%DIFDELCMD < \label{fig:datayields}
%DIFDELCMD < \end{figure}
%DIFDELCMD < 

%DIFDELCMD < %%%
\subsection*{\DIFdel{Artifacts}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{There is a minimum concentration where MLS H}%DIFDELCMD < \cs2O %%%
\DIFdel{measurements become
unreliable.
This is given in Table~\ref{tab:H2OSummary} under the ``Min.
H}%DIFDELCMD < \cs2O%%%
\DIFdel{'' column. The lowest allowable H}%DIFDELCMD < \cs2O %%%
\DIFdel{value is 0.1\,ppmv.
Differences between the retrieved middle tropospheric H}%DIFDELCMD < \cs2O %%%
\DIFdel{constraint
...
%DIFDELCMD < %%%
\DIFdel{Clouds in the field of view degrade the data in unpredictable ways. Many
...
affected. Coincident comparisons of MLS cloud flagged H}%DIFDELCMD < \cs2O
%DIFDELCMD < %%%
\DIFdel{(}\texttt{\DIFdel{status}} %DIFAUXCMD
\DIFdel{bit 16 or 32 set between 316\,--\,215\,hPa) with good
...
%DIFDELCMD < %%%
\subsection{\DIFdel{A note about the water vapor averaging kernels}}
%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend The averaging kernels are most applicable to linear and moderately
...
information. MLS \DIFdelbegin %DIFDELCMD < \prevvSlash %%%
\DIFdelend \DIFaddbegin \thisv \DIFaddend is a part of a satellite H\cs2O assessment
report to be published later this year.

\DIFaddbegin \subsection*{\DIFadd{Potential drift in lower stratospheric water vapor}}
\label{sec:H2ODrift}

\DIFadd{\mbox{%DIFAUXCMD
\citet{HurstEtal16} }%DIFAUXCMD
discuss how comparisons between MLS lower
stratospheric water vapor observations and those from balloon-borne CFH
and FPH}\footnote{\DIFadd{Cryogenic Frostpoint Hygrometer (CFH) and Frost Point
  Hygrometer (FPH)}} \DIFadd{instruments from 2004 to 2015 reveal signs of a
potential drift between the two sets of measurements, with MLS water
vapor increasing at a rate of around
\mbox{0.03\,--\,0.07\,ppmv\,yr\cp{-1}} relative to the sondes (roughly
0.6 to 1.5\% per year), starting around 2009.  The possibility of such a
drift in the MLS record is under investigation by the MLS team.
Comparisons with recently-released ACE-FTS \mbox{%DIFAUXCMD
\citep{BernathEtal04} }%DIFAUXCMD
data
show no signs of any such drift in MLS water vapor, nor do comparisons
of MLS upper stratospheric water vapor with ground-based microwave
measurements }[\emph{\DIFadd{Nedoluha}}\DIFadd{, private communication}]\DIFadd{.
}

\subsection*{\DIFadd{Data screening}}
\label{sec:H2OScreening}
\begin{description}
\item[Pressure range:] \screeningrule{316\,--\,0.002\,hPa.}
  \DIFadd{\standardrangestatement
}\standardprecisionrule
\evenstatusrule
\item[Clouds:] \DIFadd{Ignore status bit 16 (high cloud) or bit 32 (low cloud) set
indicating the presence of clouds. See artifacts for more details.
}\item[Quality field:] \screeningrule{Only profiles with a value of the
    \texttt{Quality} \emph{greater} than 1.45 should be used in
    scientific studies.}  \DIFadd{This recommendation is for scientific studies
  taking advantage of the global and long-temporal characteristics of
  the data and aims to keep the best radiometrically fit data over the
  full retrieval range. Most of the ``badness'' in quality tends to
  affect the lowermost retrieval range of the product (particularly the
  316-hPa level and also where clouds can degrade the fit). Low quality
  values often do not affect the stratospheric and mesospheric part of
  the product and much lower }\texttt{\DIFadd{Quality}} \DIFadd{values can be
  tolerated. Figure~\ref{fig:datayields} shows the percentage decline in
  good data yields as a function of quality selected for all 2005
  data. There is a slight seasonal dependence in the function with
  January--February having a 2\% higher yield at }\texttt{\DIFadd{Quality}}\DIFadd{$ =
  1.45$.  The recommended }\texttt{\DIFadd{Quality}} \DIFadd{threshold value is where the
  function starts to rapidly decline, indicating that well fit data is
  getting rejected. The chosen value will eliminate \texttildelow5\% of
  the profiles on a typical day. One may wish to ignore the
  }\texttt{\DIFadd{Quality}} \DIFadd{field for ``process'' studies or situations where a
  small number of profiles are being used, particularly if the
  stratospheric region is being studied. The MLS team should be
  consulted if one wishes to use a few select profiles having a
  }\texttt{\DIFadd{Quality}} \DIFadd{less than that recommended to ensure that the product
  is trustworthy.
}
...
\end{center}
\caption{\DIFaddFL{Percentage of data having a quality greater than that indicated
 on the x-axis for }\thisv \DIFaddFL{data processed for all of 2005.}}
\label{fig:datayields}
\end{figure}

\subsection*{\DIFadd{Artifacts}}

\DIFadd{There is a minimum concentration where MLS H}\cs2O \DIFadd{measurements become
unreliable. This is given in Table~\ref{tab:H2OSummary} under the ``Min.
H}\cs2O\DIFadd{'' column. The lowest allowable H}\cs2O \DIFadd{value is 0.1\,ppmv.
Differences between the retrieved middle tropospheric H}\cs2O \DIFadd{constraint
and the true atmospheric state can cause errors at 316 and 261\,hPa.
The error manifests either as dry ($<$1\,ppmv) or moist spikes in an
orbital time series. Such data are often accompanied with good quality
and status.
...
\DIFadd{Clouds in the field of view degrade the data in unpredictable ways. Many
instances of quality $<$1.45 occur in the presence of clouds where the
cloud screening has not rejected the radiances. Cloud radiative
scattering distorts the spectral lineshape causing poor fits and low
quality values.  However, not all MLS signals are obviously
affected. Coincident comparisons of MLS cloud flagged H}\cs2O
\DIFadd{(}\texttt{\DIFadd{status}} \DIFadd{bit 16 or 32 set between 316\,--\,215\,hPa) with good
quality AIRS show a small mean bias of 10\% but exhibit a 50\% increase
in variability for the individual differences. Therefore users should be
aware that, although the overall biases for measurements inside clouds
are similar to that for clear sky, individual profiles will exhibit
...
\DIFadd{Note the discussion of the potential drift in MLS lower stratospheric
water vapor above.
}

\DIFaddend \subsection*{Desired improvements for future data version(s)}
...
0.002 & 10.3 $\times$ 350 &152 & \DIFdelbeginFL \DIFdelFL{34 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{40 }\DIFaddendFL & 0.1 & \\
0.004 & 10.8 $\times$ 585 & 81 & \DIFdelbeginFL \DIFdelFL{16 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{23 }\DIFaddendFL & 0.1 & \\
0.010 &  8.8 $\times$ 725 & 55 & \DIFdelbeginFL \DIFdelFL{11 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{17 }\DIFaddendFL & 0.1 & \\
0.021 &  8.0 $\times$ 745 & 41 & \DIFdelbeginFL \DIFdelFL{9 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{19 }\DIFaddendFL & 0.1 & \\
0.046 &  7.4 $\times$ 540 & 35 & \DIFdelbeginFL \DIFdelFL{8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{17 }\DIFaddendFL & 0.1 & \\
0.10 &  5.8 $\times$ 745 & 24  & \DIFdelbeginFL \DIFdelFL{8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{14 }\DIFaddendFL & 0.1 & \\
0.21 &  3.6 $\times$ 670 & 19  & \DIFdelbeginFL \DIFdelFL{7 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{11 }\DIFaddendFL & 0.1 & \\
0.46 &  3.3 $\times$ 505 & 12  &  \DIFdelbeginFL \DIFdelFL{6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{8 }\DIFaddendFL & 0.1 & \\
1.0 &  2.5 $\times$ 400 &  6   &  \DIFdelbeginFL \DIFdelFL{4 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{7 }\DIFaddendFL & 0.1 & \\
2.2 &  3.5 $\times$ 385 &  4   &  \DIFdelbeginFL \DIFdelFL{5 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{7 }\DIFaddendFL & 0.1 & \\
4.6 &  3.4 $\times$ 350 &  4   &  \DIFdelbeginFL \DIFdelFL{7 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{5 }\DIFaddendFL & 0.1 & \\
10 &  2.8 $\times$ 290 &  6    & \DIFdelbeginFL \DIFdelFL{9 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{19 }\DIFaddendFL & 0.1 & \\
22 &  3.2 $\times$ 265 &  5    &  \DIFdelbeginFL \DIFdelFL{7 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{5 }\DIFaddendFL & 0.1 & \\
46 &  3.2 $\times$ 230 &  5    &  4 & 0.1 & \\
68 &  3.1 $\times$ 190 &  5    &  \DIFdelbeginFL \DIFdelFL{6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{9 }\DIFaddendFL & 0.1 & \\
83 &  3.1 $\times$ 190 &  7    &  \DIFdelbeginFL \DIFdelFL{7 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{9 }\DIFaddendFL & 0.1 & \\
...
%%% TeX-master: "v4-x-report"
%%% End: 
 \DIFdelbegin \DIFdel{<}\DIFdelend \speciestitle{Hydrogen Chloride}{HCl}{HCl}{%
...
therefore be restricted to the lower stratosphere\DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{; in this region,
studies of tendencies and longer-term trends are justified (e.g., see
the HCl comparisons discussed by \mbox{%DIFAUXCMD
\citet{MahieuEtal14}}%DIFAUXCMD
).
}\DIFaddend 
...
\DIFdelbegin \DIFdel{We also do not
...
spectroscopy, etc.\ on the HCl retrievals\DIFaddbegin \DIFadd{; there are several error
sources (mostly from radiometric calibration components) that contribute
significantly to the total error}\DIFaddend .  These values are intended to
...
recommended an accuracy estimate of \DIFaddbegin \DIFadd{no better than }\DIFaddend 10\% in this region
(or about 0.3\,ppbv).  \DIFdelbegin \DIFdel{Given the }\DIFdelend \DIFaddbegin \DIFadd{For the lower stratosphere, given the }\DIFaddend agreement
between the two bands' retrievals \DIFdelbegin \DIFdel{in
the
lower stratosphere, we maintain the }\DIFdelend \DIFaddbegin \DIFadd{as well as some trend studies (for the
standard product), we use the more }\DIFaddend formal accuracy estimates \DIFdelbegin \DIFdel{in
this region }\DIFdelend (see
...
\item[Clouds:] \DIFadd{Thick clouds can add significant artifacts (mainly in the
...
mid-latitudes); while this is still true for v4 \DIFdelbegin \DIFdel{.2 }\DIFdelend data, MLS data at this
pressure level are potentially useful and accurate enough at high
latitudes.

\subsection*{Artifacts}
\begin{itemize} 
\item We do not recommend the use of the MLS HCl standard product \DIFdelbegin \DIFdel{(from
  band 14) }\DIFdelend in 
  the upper stratosphere and lower mesosphere, \DIFaddbegin \DIFadd{especially }\DIFaddend in 
  terms of \DIFdelbegin \DIFdel{detailed }\DIFdelend trend studies, for reasons mentioned above.
\item The HCl values at 147\,hPa are biased high and generally not
  usable (except possibly at high latitudes).  Please consult \DIFaddbegin \DIFadd{with }\DIFaddend the MLS
...
20              & 0.2 &   15            &   3 $\times$ 200 & \DIFdelbeginFL \DIFdelFL{0.1   }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.15  }\DIFaddendFL &  10     & \\
46              & 0.2 & 10 to $>$ 40    &   3 $\times$ 250 & 0.2   &  \DIFdelbeginFL \DIFdelFL{10 to $>$ 40  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{20     }\DIFaddendFL & \\
68              & 0.2 & 15 to $>$ 80    &   3 $\times$ 300 & 0.2   &  \DIFdelbeginFL \DIFdelFL{10 to $>$ 80   }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{25     }\DIFaddendFL & \\
100             & 0.3 & 30 to $>$ 100   &   3 $\times$ 350 & \DIFdelbeginFL \DIFdelFL{0.15  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.2  }\DIFaddendFL &   \DIFdelbeginFL \DIFdelFL{10 to $>$ 100  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{40     }\DIFaddendFL & \\
...
The standard \DIFdelbegin \DIFdel{HNO3 }\DIFdelend \DIFaddbegin \DIFadd{HNO}\cs3 \DIFaddend product is derived from the 240-GHz retrievals at
...
147\,hPa and slightly lower at 100\,hPa.  \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend A summary of the \DIFdelbegin \DIFdel{precision and }\DIFdelend \DIFaddbegin \DIFadd{estimated
precision, }\DIFaddend resolution (vertical and horizontal)\DIFaddbegin \DIFadd{, and systematic
uncertainty }\DIFaddend of the \thisv HNO\cs3 measurements as a function of altitude
is given in Table~\ref{tab:HNO3Summary}.
\DIFdelbegin \DIFdel{The impact of various sources of
systematic uncertainty was quantified for v3.3, and it is expected that
these estimates will be similar for }%DIFDELCMD < \thisv%%%
\DIFdel{.  Table~\ref{tab:HNO3Summary}
...
updated for }%DIFDELCMD < \thisv %%%
\DIFdel{at a later date).  The overall uncertainty for an
...
precision, resolution, and accuracy of the MLS }%DIFDELCMD < \thisv %%%
\DIFdel{HNO}%DIFDELCMD < \cs3
%DIFDELCMD < %%%
\DIFdel{measurements are given below.
}\DIFdelend 
...
however, this procedure produces \DIFdelbegin \DIFdel{a }\DIFdelend \DIFaddbegin \DIFadd{an }\DIFaddend upper limit on the precision-related
...
The effects of various sources of systematic uncertainty (e.g.,
instrumental issues, spectroscopic uncertainty, and approximations in
the retrieval formulation and implementation) on the MLS \DIFdelbegin \DIFdel{v3.3 }\DIFdelend \DIFaddbegin \thisv \DIFaddend HNO\cs3
measurements \DIFdelbegin \DIFdel{were }\DIFdelend \DIFaddbegin \DIFadd{have been }\DIFaddend quantified through a comprehensive set of
\DIFdelbegin \DIFdel{retrieval
simulations; results for }%DIFDELCMD < \thisv%%%
\DIFdel{, to be completed at a later date, are
expected to be similar.  The results of the v3.3 uncertainty analysis
are summarized in Table~\ref{tab:HNO3Summary}}\DIFdelend \DIFaddbegin \DIFadd{retrievals of synthetic radiances}\DIFaddend ; see \citet{SanteeEtal07hno3} for
\DIFdelbegin \DIFdel{further details of how the analysis was
conducted and the magnitude of }\DIFdelend \DIFaddbegin \DIFadd{details of a similar analysis conducted on MLS v2.2 HNO}\cs3 \DIFadd{data.  The
overall systematic uncertainty, or accuracy, is calculated by combining
(RSS) the contributions from both }\DIFaddend the expected biases \DIFdelbegin \DIFdel{, additional
scatter ,
and possible scaling errors }\DIFdelend \DIFaddbegin \DIFadd{and the additional
scatter }\DIFaddend each source of uncertainty may introduce into the data.  In
aggregate, \DIFdelbegin \DIFdel{systematic uncertainties }\DIFdelend \DIFaddbegin \DIFadd{the factors considered in these simulations }\DIFaddend are estimated to
\DIFdelbegin \DIFdel{induce in the HNO}%DIFDELCMD < \cs3 %%%
\DIFdel{measurements biases that vary with altitude
between $\pm$0.5 and $\pm$2}\DIFdelend \DIFaddbegin \DIFadd{give rise to a total systematic uncertainty ranging from approximately
0.1 to 2.4}\DIFaddend \,ppbv\DIFdelbegin \DIFdel{and multiplicative errors of
$\pm$5\,--\,15\% through most of the stratosphere, rising to \mbox{\texttildelow$\pm$30\%} at 215\,hPa and \texttildelow50\% at and
above2.2\,hPa.  These uncertainty estimates are generally consistent
with the results of }\DIFdelend \DIFaddbegin \DIFadd{, depending on the level, in the MLS }\thisv \DIFadd{HNO}\cs3 \DIFadd{data
(see Table~\ref{tab:HNO3Summary}).
}

\subsection*{\DIFadd{Comparisons with other datasets}}

\thisv \DIFadd{HNO}\cs3 \DIFadd{profiles generally show only small differences in
magnitude from v3.3 when each data version is screened according to the
criteria above.  Therefore, the }\DIFaddend comparisons with correlative \DIFdelbegin \DIFdel{datasets, as discussed
briefly below}\DIFdelend \DIFaddbegin \DIFadd{data are
expected to be very similar to those described for v3.3 by
\mbox{%DIFAUXCMD
\citet{EOSMLSV33V34Quality}}%DIFAUXCMD
}\DIFaddend .
...
\begin{description}
\item[Quality:] \qualityrule{0.8} \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD <   %%%
\DIFdelend This threshold for \texttt{Quality}
  typically excludes \texttildelow1\,--\,3\% of HNO\cs3 profiles on a
  daily basis; it is a conservative value that potentially discards a
  significant fraction of ``good'' data points while not necessarily
  identifying all ``bad'' ones.  A significant fraction of the HNO\cs3
  profiles in \thisv show a ``notch'', with unexpectedly low \DIFaddbegin \DIFadd{(often
  negative in the tropics) }\DIFaddend values at 100\,hPa and high values at
  147\,hPa; many such profiles are removed by using this
  \texttt{Quality} threshold.

\item[Convergence:] \convergencerule{1.03} \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD <   %%%
\DIFdelend On a typical day this
  threshold for \texttt{Convergence} discards a very small fraction of
  the data, rarely eliminating more than 0.1\% of the HNO\cs3 profiles.
  Some such profiles show unphysical behavior.

\item[Clouds:] \screeningrule{Clouds impact HNO\cs3 data in the UTLS,
    see discussion below and the discussion on ``outliers'' that
    follows.}  \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD <   %%%
\DIFdelend Nonzero but even values of \texttt{Status} indicate that
  the profile has been marked as questionable, typically because the
  measurements may have been affected by the presence of thick clouds.
  Globally \texttildelow1\,--\,2\% of profiles are identified in this
  manner, with the fraction of profiles possibly impacted by clouds
  rising to \texttildelow5\% on average in the tropics.  Clouds
...
\item[Outliers:] \screeningrule{Alternative screening approaches in the
    UTLS remove outliers while reducing ``false positives''} \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD <   %%%
\DIFdelend While the
  number, and particularly the extreme values of, outliers in \thisv
  HNO\cs3 at levels between 316 and 100 (sometimes to 68) hPa is greatly
  reduced over that in v3.3, such outliers are still present.  These
  typically appear as highly negative mixing ratios at the lowest
  ...
  as well as many \DIFaddbegin \DIFadd{(but not all) }\DIFaddend with the ``notch'' structure \DIFdelbegin \DIFdel{begtween }\DIFdelend \DIFaddbegin \DIFadd{between }\DIFaddend 147
  and 100\,hPa.  Most or all of the remainder of the profiles that are
...
\item[Quality:] \screeningrule{Only profiles with a value of the
  ...
  conservative value that potentially discards some ``good'' data points
  while not necessarily identifying all ``bad'' ones.
...
\subsection*{\DIFdelbegin \DIFdel{Comparisons with other datasets}\DIFdelend \DIFaddbegin \DIFadd{Artifacts}\DIFaddend }

\DIFaddbegin \begin{itemize}
\item \DIFadd{There is a persistent ``notch'' at 100\,hPa, noted in
  Figures~\ref{fig:zmv3v4diffs} and \ref{fig:outlierprofs}, that is most
  pronounced in the tropics but also apparent in midlatitudes.  }\DIFaddend \thisv
  HNO\cs3 \DIFdelbegin \DIFdel{profiles generally show only small differences in magnitude from v3.3 when each data version is screened according to the criteria above.  Therefore,
  the comparisons with correlative data are
expected to be very similar to those described for v3.3 by
\mbox{%DIFAUXCMD
\citet{EOSMLSV33V34Quality}}%DIFAUXCMD
.
}\DIFdelend \DIFaddbegin \DIFadd{at 147\,hPa is consistently slightly higher than that at
  100\,hPa.  As can be seen in Figure~\ref{fig:outlierprofs}, this
  feature is very strong in many profiles that are eliminated by one or
  more of the screening criteria.  However,
  Figure~\ref{fig:outlierprofs} (right panels) and
  Figure~\ref{fig:zmv3v4diffs} (lower right panel) show that this
  feature is more pronounced than it was in }\prevv\DIFadd{, and it is reduced,
  but by no means eliminated, by following the recommended screening
  procedures.  This feature was persistent throughout }\thisv \DIFadd{testing,
  and its origin is still unclear.
}\end{itemize}
\DIFaddend 

\DIFdelbegin %DIFDELCMD < \begin{DIFnomarkup}
%DIFDELCMD < \begin{table}
%DIFDELCMD < \caption{Summary of Aura MLS \thisv HNO\cs3 Characteristics}\vspace{0.5ex}
%DIFDELCMD < \label{tab:HNO3Summary}
%DIFDELCMD < \begin{minipage}{\linewidth}\small
%DIFDELCMD <   \renewcommand{\thefootnote}{\thempfootnote}
%DIFDELCMD <   \centering\begin{tabular}{cccccl} \toprule
%DIFDELCMD < \parbox[m]{16mm}{\bfseries\centering{Pressure\\ / hPa}} &
%DIFDELCMD < \parbox[m]{22mm}{\bfseries\centering{Resolution\\ \mbox{V $\times$ H}%
%DIFDELCMD < \footnote{Horizontal resolution in along-track direction.} \\ / km}} &
%DIFDELCMD < \parbox[m]{16mm}{\bfseries\centering{Precision%
%DIFDELCMD < \footnote{Precision on individual profiles, determined from observed
%DIFDELCMD <  scatter in the data in a region of minimal atmospheric variability.} \\/ ppbv}} &
%DIFDELCMD < \parbox[m]{18mm}{\bfseries\centering{Bias\\uncertainty%
%DIFDELCMD < \footnote{Values should be interpreted as \mbox{2-$\sigma$} estimates
%DIFDELCMD <  of the probable magnitude.}\\ / ppbv}} &
%DIFDELCMD < \parbox[m]{18mm}{\bfseries\centering{Scaling\\uncertainty%
%DIFDELCMD < \footnotemark[\value{mpfootnote}]\\/ \%}} &
%DIFDELCMD < \textbf{Comments} \\
%DIFDELCMD < %
%DIFDELCMD < \midrule
%DIFDELCMD < %
%DIFDELCMD < 0.68\,--\,0.001 & ---  & ---    & ---    & --- & Unsuitable for scientific
%DIFDELCMD <   use\\
%DIFDELCMD < %
%DIFDELCMD < 1.0 & 4 $\times$ 650\,--\,750  & $\pm$1.2 & $\pm$0.5 & $\pm$50\% & Caution, averaging
%DIFDELCMD < recommended \\
%DIFDELCMD < %
%DIFDELCMD < 1.5 & 4.5 $\times$ 550\,--\,600 & $\pm$1.2  & $\pm$0.5 & $\pm$50\% & Averaging recommended \\
%DIFDELCMD < %
%DIFDELCMD < 2.1 & 5 $\times$ 450\,--\,500 & $\pm$0.8  & $\pm$1.0 & $\pm$50\% & \\
%DIFDELCMD < %
%DIFDELCMD < 3.2 & 4.5 $\times$ 400 & $\pm$0.6  & $\pm$0.6  & $\pm$10\,--\,15\% & \\
%DIFDELCMD < %
%DIFDELCMD < 4.6 & 4 $\times$ 300\,--\,350 & $\pm$0.6  & $\pm$0.6  & $\pm$10\,--\,15\% & \\
%DIFDELCMD < % 
%DIFDELCMD < 15\,--\,6.8  & 3\,--\,4 $\times$ 250\,--\,300 & $\pm$0.6 & $\pm$1\,--\,2  &
%DIFDELCMD <   $\pm$10\% & \\
%DIFDELCMD < %
%DIFDELCMD < 22 & 4.5 $\times$ 500 & $\pm$0.6 & $\pm$1\,--\,2 &
%DIFDELCMD < $\pm$10\% & \\
%DIFDELCMD < %
%DIFDELCMD < 147\,--\,32  & 3\,--\,4 $\times$ 350\,--\,400 & $\pm$0.6 & $\pm$0.5\,--\,1 &
%DIFDELCMD < $\pm$5\,--\,10\% & \\
%DIFDELCMD < %
%DIFDELCMD < 215        & 4\,--\,4.5 $\times$ 450  & $\pm$0.6 & $\pm$1    &
%DIFDELCMD < \texttildelow$\pm$30\% & \\
%DIFDELCMD < %
%DIFDELCMD < 316        & ---      & ---    & ---    & --- & Unsuitable for
%DIFDELCMD < scientific use\\
%DIFDELCMD < %
%DIFDELCMD < 1000\,--\,464  & ---      & ---    & ---    & --- & Not retrieved\\
%DIFDELCMD < %
%DIFDELCMD < \bottomrule
%DIFDELCMD < \end{tabular}\par
%DIFDELCMD < \end{minipage}
%DIFDELCMD < \end{table}
%DIFDELCMD < \end{DIFnomarkup}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsection*{\DIFadd{Desired improvements for future data version(s)}}
\DIFaddend 

\DIFaddbegin \begin{itemize}
\item \DIFadd{Diagnose and eliminate the unphysical notch (minimum) at
  100\,hPa.
}\end{itemize}
...
0.68\,--\,0.001 & ---  & ---    & ---    &  Unsuitable for scientific
  use\\
%
1.5\,--\,1.0 & 4.5 $\times$ 550\,--\,750  & $\pm$1.2 & $\pm$0.3 & Caution, averaging
recommended \\
%
2.1 & 5 $\times$ 450\,--\,500 & $\pm$0.8  & $\pm$0.5 & \\
%
3.2 & 4.5 $\times$ 400 & $\pm$0.6  & $\pm$0.1  & \\
%
15\,--\,4.6  & 3\,--\,4 $\times$ 250\,--\,350 & $\pm$0.6 & $\pm$0.5  & \\
%
22 & 4.5 $\times$ 500 & $\pm$0.6 & $\pm$2.4 & \\
%
32 & 4 $\times$ 400 & $\pm$0.6 & $\pm$1.5 & \\
%
147\,--\,46  & 3\,--\,4 $\times$ 350\,--\,400 & $\pm$0.6 & $\pm$1.0 & \\
%
215        & 4\,--\,4.5 $\times$ 450  & $\pm$0.6 & $\pm$1.1    & \\
%
316        & ---      & ---    & ---    & Unsuitable for
scientific use\\
%
...
described in \citet{PickettEtal06}. \DIFdelbegin \DIFdel{While there are significant
improvements from v1.5 to }%DIFDELCMD < \prevv%%%
\DIFdel{, the HO}%DIFDELCMD < \cs2 %%%
\DIFdel{data quality in }%DIFDELCMD < \thisv %%%
\DIFdel{is
generally similar to }%DIFDELCMD < \prevv%%%
\DIFdel{.  }\DIFdelend The estimated uncertainties, precisions,
and resolution for \thisv HO\cs2 are summarized below in
Table~\ref{tab:HO2Summary}. 
\DIFdelbegin \DIFdel{Note that the systematic uncertainties are
from }%DIFDELCMD < \prevv %%%
\DIFdel{and, while they are not expected to change significantly in
}%DIFDELCMD < \thisv%%%
\DIFdel{, they will be updated for this new version at a later date.
}\DIFdelend 

%DIF >  Note that the systematic uncertainties are
%DIF >  from \prevv and, while they are not expected to change significantly in
%DIF >  \thisv, they will be updated for this new version at a later date.
\DIFaddbegin 

\DIFaddend An algorithm to retrieve daily zonal means of HO\cs2 over an extended
...
\caption{Monthly zonal mean of retrieved HO\cs2 and its estimated
  ...
  (c). Panels (e) and (f) are equivalent to (c) and (d) but using \DIFdelbeginFL \DIFdelFL{v2.2
  }\DIFdelendFL \DIFaddbeginFL \prevv
  \DIFaddendFL data. The average in panels (a)\,--\,(d) using \thisv data includes 3052
  profiles, while the average in panels (e)\,--\,(f) using \DIFdelbeginFL \DIFdelFL{v2.2 }\DIFdelendFL \DIFaddbeginFL \prevv \DIFaddendFL data
...
The \DIFdelbegin \DIFdel{scaling uncertainty is the part of the systematic uncertainty that
scales with HO}%DIFDELCMD < \cs2 %%%
\DIFdel{concentration, e.g. spectroscopic line strength. Bias
uncertainty is the part of the uncertainty that is independent of
concentration. For both bias and scaling uncertainty, quantification of the combined effect in MLS calibration, spectroscopy etc., on the data
productwas determined by calculating the effects of each source of
uncertainty }\DIFdelend \DIFaddbegin \DIFadd{effect of each identified source of systematic error on MLS
measurements of radiance has been quantified and modeled
\mbox{%DIFAUXCMD
\citep{ReadEtal07}}%DIFAUXCMD
. These quantified effects correspond to either
...
and/or design requirements}\DIFaddend . These accuracy calculations \DIFdelbegin \DIFdel{are }\DIFdelend \DIFaddbegin \DIFadd{were performed
with more realistic HO}\cs2 \DIFadd{atmospheric profiles than }\DIFaddend for \prevv
\DIFdelbegin \DIFdel{products.  While
no significant change is expected from }%DIFDELCMD < \prevv %%%
\DIFdel{to }%DIFDELCMD < \thisv%%%
\DIFdel{, a comprehensive
error analysis for }%DIFDELCMD < \thisv %%%
\DIFdel{will be conducted. Bias uncertainty }\DIFdelend \DIFaddbegin \DIFadd{estimates.  The HO}\cs2 \DIFadd{bias }\DIFaddend can be eliminated by taking day-night
differences over the entire recommended pressure range. The \DIFdelbegin \DIFdel{accuracy of the HO}%DIFDELCMD < \cs2 %%%
\DIFdel{measurement due to systematic
errors is a product of scaling uncertainty and the observed HO}%DIFDELCMD < \cs2
%DIFDELCMD < %%%
\DIFdel{concentration. The }\DIFdelend overall
...
\item[Convergence:] \convergencerule{1.1} In version v2.2 this
  ...
  version, \thisv, there are often zero or very few \DIFdelbegin \DIFdel{non-convergence
  }\DIFdelend \DIFaddbegin \DIFadd{non-converged
  }\DIFaddend profiles.
\end{description}
...
\begin{minipage}{\linewidth}
\small\centering\DIFdelbeginFL %DIFDELCMD < \begin{tabular}{rccccl}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \begin{tabular}{rcccl}
\DIFaddendFL \toprule
...
\parbox{15ex}{\bfseries\centering \DIFdelbeginFL \DIFdelFL{Bias uncertainty }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Day--night accuracy }\DIFaddendFL / \mbox{10\cp6 cm\cp{$-$3}}} &
\DIFdelbeginFL \parbox{12ex}{%DIFDELCMD < \bfseries\centering %%%
\DIFdelFL{Scaling uncertainty / \%}} %DIFAUXCMD
%DIFDELCMD < &
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL 

\DIFaddendFL \textbf{Comments} \\
\midrule
 $<$ 0.03\,hPa  & ---   & ---               & ---  &  \DIFdelbeginFL \DIFdelFL{--- }%DIFDELCMD < & %%%
\DIFdelendFL Unsuitable for scientific use\\
 0.046\,hPa     & 10    & 6                 & \DIFdelbeginFL \DIFdelFL{0.39}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.01 }\DIFaddendFL &  \DIFdelbeginFL \DIFdelFL{22  }%DIFDELCMD < & %%%
\DIFdelendFL Use day--night difference \\
 0.10\,hPa      & 7     & 10                & \DIFdelbeginFL \DIFdelFL{0.46}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.2  }\DIFaddendFL &  \DIFdelbeginFL \DIFdelFL{16  }%DIFDELCMD < & %%%
\DIFdelendFL Use day--night difference \\
 1.0 \,hPa      & 5     & 11                & \DIFdelbeginFL \DIFdelFL{1.1 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.2  }\DIFaddendFL &  \DIFdelbeginFL \DIFdelFL{6   }%DIFDELCMD < & %%%
\DIFdelendFL Use day--night difference \\
 10  \,hPa      & 4     & 50                & \DIFdelbeginFL \DIFdelFL{37  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{14   }\DIFaddendFL &  \DIFdelbeginFL \DIFdelFL{20  }%DIFDELCMD < & %%%
\DIFdelendFL Use day--night difference \\
 $>$ 22\,hPa    & ---   & ---               & ---  &  \DIFdelbeginFL \DIFdelFL{--- }%DIFDELCMD < & %%%
\DIFdelendFL Unsuitable for scientific use\\
\bottomrule
\end{tabular}
\end{minipage}
...
\citep{ReadEtal07}.  These \DIFaddbegin \DIFadd{(updated) }\DIFaddend values are intended to represent
$2\sigma$ estimates of accuracy.  The largest contributors to possible
errors for HOCl are contaminant species, gain compression, and sideband
ratio uncertainties.  The Table gives a range of error estimates (for
\DIFdelbegin \DIFdel{low and
high }\DIFdelend \DIFaddbegin \DIFadd{the range of }\DIFaddend pressures).  The average changes for upper stratospheric
HOCl between v3.3 and v4.2 are well within the quoted accuracy estimates
(which may be somewhat conservative).  \DIFaddbegin \DIFadd{The HOCl signal becomes too small
compared to the systematic uncertainties to allow for reliable
retrievals at pressures larger than 10 hPa.
}\DIFaddend 
...
\item[Pressure range:] \screeningrule{10\,--\,2.2\,hPa}
  ...
  larger than about 10\,hPa \DIFdelbegin \DIFdel{currently }\DIFdelend make this product unsuitable for use in the
  lower stratosphere. Regarding the topmost altitude range, the
  sensitivity to \emph{a priori} increases rapidly at pressures of
...
\item There are \DIFdelbegin \DIFdel{still }\DIFdelend significant artifacts in the mean values (large negative
  values) for HOCl in the lower stratosphere, where the use of this
...
2.2 to 10   &  10 & 10    &   6  & \DIFdelbeginFL \DIFdelFL{30}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{40}\DIFaddendFL \,--\,80 & \DIFdelbeginFL \DIFdelFL{\texttildelow30\,--\,100 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\texttildelow150 }& \DIFaddFL{Some averaging required }\DIFaddendFL \\ 
...
\begin{figure}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{figures/iwp-figure-bitmap}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{figures/iwp-figure-bitmap.jpg}
\DIFaddendFL \caption{Diagram to illustrate the MLS IWC and IWP measurement. The
...
The secondary \thisv N\cs2O 640-GHz product \DIFdelbegin \DIFdel{will be made }\DIFdelend \DIFaddbegin \DIFadd{is }\DIFaddend available for the period
...
The \DIFdelbegin \DIFdel{``accuracy '' }\DIFdelend \DIFaddbegin \DIFadd{accuracy }\DIFaddend values given in Table~\ref{tab:N2O640Summary} were obtained
for both \DIFdelbegin \DIFdel{v3.x }\DIFdelend \DIFaddbegin \DIFadd{v4 }\DIFaddend N\cs2O products using the same detailed analyses presented
for MLS \texttt{N2O-640} v2.2 data in \citet{LambertEtal07} to quantify
...
\DIFdelbegin \DIFdel{Accuracy for the }%DIFDELCMD < \thisv %%%
\DIFdel{N}%DIFDELCMD < \cs2O %%%
\DIFdel{data is 
...
Retrievals of N\cs2O to pressures greater than \DIFdelbegin \DIFdel{147}\DIFdelend \DIFaddbegin \DIFadd{100}\DIFaddend \,hPa \emph{may} be
...
0.46         &  11.0 $\times$  655 &   15  & $>$100 &  \DIFdelbeginFL \DIFdelFL{0.5 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{16 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$>$100 }\DIFaddendFL & \\ 
0.68         &   9.7 $\times$  540 &   17  & $>$100 &  \DIFdelbeginFL \DIFdelFL{0.6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{16 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{89 }\DIFaddendFL & \\ 
1.0          &   8.6 $\times$  440 &   18  & $>$100 &  \DIFdelbeginFL \DIFdelFL{0.8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{16 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{50 }\DIFaddendFL & \\ 
2.2          &   7.3 $\times$  340 &   19  &   64   &  \DIFdelbeginFL \DIFdelFL{2.4 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{18 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{36 }\DIFaddendFL & \\ 
4.6          &   6.5 $\times$  285 &   17  &   23   &  \DIFdelbeginFL \DIFdelFL{3  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{5  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{11 }\DIFaddendFL & \\ 
10           &   6.0 $\times$  265 &   16  &   12   &  \DIFdelbeginFL \DIFdelFL{5  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{7  }\DIFaddendFL &  \DIFdelbeginFL \DIFdelFL{6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{7 }\DIFaddendFL & \\ 
22           &   5.6 $\times$  305 &   15  &    9   & 10  &  \DIFdelbeginFL \DIFdelFL{7 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{6 }\DIFaddendFL & \\ 
46           &   4.9 $\times$  385 &   14  &    7   & \DIFdelbeginFL \DIFdelFL{16  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{30  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{7 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{10 }\DIFaddendFL & \\ 
68           &   5.4 $\times$  420 &   16  &    6   & \DIFdelbeginFL \DIFdelFL{20  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{55  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{22 }\DIFaddendFL & \\
100          &   3.8 $\times$  500 &   20  &    7   &\DIFdelbeginFL \DIFdelFL{$>50$  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{124  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{$>$30 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{44 }\DIFaddendFL & Consult with MLS science team\\ 
...
\midrule
$\leq$0.33   & ---                 & ---   & ---       & --- & --- & Unsuitable for scientific use \\   
0.46         &   8.9 $\times$  530 &   12  &  $>$100   &  \DIFdelbeginFL \DIFdelFL{0.5 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{1 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{16  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{88  }\DIFaddendFL & \\     
0.68         &   7.4 $\times$  430 &   13  &  $>$100   &  \DIFdelbeginFL \DIFdelFL{0.6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{15  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{89  }\DIFaddendFL & \\     
1.0          &   6.2 $\times$  345 &   14  &  $>$100   &  \DIFdelbeginFL \DIFdelFL{0.6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{12  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{50  }\DIFaddendFL & \\   
2.2          &   4.8 $\times$  300 &   15  &   49      &  \DIFdelbeginFL \DIFdelFL{1.2 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{9  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{27  }\DIFaddendFL & \\   
4.6          &   4.1 $\times$  295 &   14  &   18      &  \DIFdelbeginFL \DIFdelFL{3  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{6 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{9  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{14  }\DIFaddendFL & \\          
10           &   3.9 $\times$  360 &   13  &   10      & \DIFdelbeginFL \DIFdelFL{7  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{12 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{9  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{11  }\DIFaddendFL & \\          
22           &   4.2 $\times$  410 &   14  &    8      & \DIFdelbeginFL \DIFdelFL{19  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{22 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{13  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{14  }\DIFaddendFL & \\          
46           &   4.4 $\times$  495 &   16  &    7      & \DIFdelbeginFL \DIFdelFL{32  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{40 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{14  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{19  }\DIFaddendFL & \\          
68           &   5.5 $\times$  555 &   20  &    8      & \DIFdelbeginFL \DIFdelFL{32  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{70 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{13  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{28  }\DIFaddendFL & \\          
100          &   5.2 $\times$  610 &   25  &    9      & \DIFdelbeginFL \DIFdelFL{70  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{51 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{25  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{18  }\DIFaddendFL & \\          
147          & ---                 & ---   & ---       & --- & --- & Unsuitable for scientific use \\   
...
The MLS temperature profiles from which the WMO tropopause is determined 
are not screened per the instructions of section~\ref{sec:StandardTemperature} 
and users may wish to reject columns for which standard screening rejects 
...
\paragraph*{Column values} The estimated precisions for the \DIFdelbegin \DIFdel{v4.2 }\DIFdelend \DIFaddbegin \thisv \DIFaddend MLS 
...
calibration, spectroscopy, etc., through the \DIFdelbegin \DIFdel{v2.2 }\DIFdelend \DIFaddbegin \DIFadd{(}\thisv\DIFadd{) }\DIFaddend measurement system.  \DIFdelbegin \DIFdel{Results using the v4.2 algorithms are not expected to differ
significantly.  }\DIFdelend The 
values shown here are intended to represent 2$\sigma$ estimates of accuracy.  Comparison of MLS O\cs3 with
well-established data sets shows no evidence of significant biases \DIFaddbegin \DIFadd{overall, although 
the oscillations in the UTLS at low latitudes lead to some systematic effects which can reach 20-40\%, depending on the pressure level}\DIFaddend . 
For more details, see the MLS validation papers by \citet{FroidevauxEtal08O3},
...
on the MLS website under ``Publications''.  \DIFdelbegin \DIFdel{Future validation studies using v4.2 data will focus }\DIFdelend \DIFaddbegin \DIFadd{In particular, see the comprehensive work by \mbox{%DIFAUXCMD
\citet{HubertEtal16} }%DIFAUXCMD
(more related information further below). In recent years, validation studies have focused more }\DIFaddend on longer-term changes \DIFdelbegin \DIFdel{(for which good stability is }\DIFdelend \DIFaddbegin \DIFadd{or drifts (with good stability }\DIFaddend being observed versus other reliable measurements) and on the UTLS region.
...
the multi-instrument mean values as well as to SAGE II ozone.  \DIFdelbegin \DIFdel{Future
validation studies will focus more on longer-term changes and on the
UTLS region, especially in the tropics. }\DIFdelend The temporal stability of the Aura MLS ozone dataset has been shown to be very good, in comparison to lidar datasets \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citet{NairEtal12}}%DIFAUXCMD
, as well as in other }\DIFdelend \DIFaddbegin \DIFadd{(\mbox{%DIFAUXCMD
\citet{NairEtal12}}%DIFAUXCMD
). The }\DIFaddend more recent
work \DIFdelbegin \DIFdel{. Aura MLS }\DIFdelend \DIFaddbegin \DIFadd{by \mbox{%DIFAUXCMD
\citet{HubertEtal16} }%DIFAUXCMD
includes both the lidar network and the ozonesonde network as references for a comprehensive satellite data intercomparison study. The latter authors show that average biases between MLS and latitudinally-binned data from lidar and ozonesonde sites across the globe is typically within 5\% or better, with poorer behavior (known vertical oscillations) at low latitudes in the UTLS.  In terms of drifts, the Aura MLS ozone dataset is shown (in the above work) to be very stable, a term also applied only to the SAGE II dataset; MLS exhibits drifts with respect to the ground-based networks that fall within 1.5 to 2\% per decade, with zero drift encompassed by the error bars (i.e. non-significant drifts), at least in the middle stratosphere. The Aura MLS }\DIFaddend data, in combination with older datasets, provides a critical tool for \DIFaddbegin \DIFadd{the }\DIFaddend study of global O\cs3 in a changing climate \DIFaddbegin \DIFadd{and }\DIFaddend into the expected \DIFdelbegin \DIFdel{period }\DIFdelend O\cs3 recovery \DIFaddbegin \DIFadd{period, }\DIFaddend as anthropogenic ozone depleting substances decline in concentration. 
...
\item[Oscillations in tropical UTLS ozone:] There has been some improvement 
  ...
  (but not eliminating) \DIFaddbegin \DIFadd{systematic }\DIFaddend vertical oscillations. Further characterization 
  of MLS tropical \DIFdelbegin \DIFdel{UT }\DIFdelend \DIFaddbegin \DIFadd{UTLS }\DIFaddend data, in particular, is warranted
...
\DIFdelbegin %DIFDELCMD < \begin{DIFnomarkup}
%DIFDELCMD < \begin{table} 
%DIFDELCMD < \caption{Summary for MLS ozone}\vspace{0.5ex} 
%DIFDELCMD < \label{tab:O3Summary} 
%DIFDELCMD < \begin{minipage}{\linewidth}\small 
%DIFDELCMD < \centering\begin{tabular}{ccccccl}
%DIFDELCMD < \toprule 
%DIFDELCMD < \parbox[m]{15mm}{\centering\textbf{Pressure / hPa}} & 
%DIFDELCMD < \parbox[m]{24mm}{\centering\textbf{Resolution\\ Vert. $\times$ Horiz.}} & 
%DIFDELCMD < \multicolumn{2}{c}{\parbox[m]{20mm}{\centering\textbf{Precision\footnote{Precision  
%DIFDELCMD <         on individual profiles}\\ppmv\hfill\%}}} & 
%DIFDELCMD < \multicolumn{2}{c}{\parbox[m]{20mm}{\centering\textbf{Accuracy\footnote{%
%DIFDELCMD <         As estimated from systematic uncertainty characterization tests.
%DIFDELCMD <         Stratospheric values are expressed in ppmv with a typical
%DIFDELCMD <         \emph{equivalent} percentage value quoted.  215\,--\,100\,hPa errors are
%DIFDELCMD <         the sum of the ppmv \emph{and percentage} scaling uncertainties quoted.
%DIFDELCMD <         Accuracy values, especially for pressures from 100 to 316\,hPa will be
%DIFDELCMD <         re-evaluated, but the estimates for v2.2 data are currently used in this
%DIFDELCMD <         Table.}% 
%DIFDELCMD <       \\ppmv\hfill\%}}}  
%DIFDELCMD < & \textbf{Comments} \\ 
%DIFDELCMD < \midrule 
%DIFDELCMD < $\leq$ 0.01 & ---            & ---  & ---    & ---  & ---  & Unsuitable for scientific use \\   
%DIFDELCMD < 0.02 & 5.5 $\times$ 200 & 1.2  & 300    & 0.1  &  35  & \\ 
%DIFDELCMD < 0.05 & 5.5 $\times$ 200 & 0.8  & 150    & 0.2  &  30  & \\ 
%DIFDELCMD < 0.1  & 4 $\times$ 400 & 0.5  &  60    & 0.2  &  20  & \\ 
%DIFDELCMD < 0.2  & 3 $\times$ 450 & 0.4  &  30    & 0.1  &   7  & \\ 
%DIFDELCMD < 0.5  & 3.5 $\times$ 550 & 0.3  &  20    & 0.1  &   5  & \\ 
%DIFDELCMD < 1    & 3 $\times$ 500 & 0.2  &  7       & 0.2  &   7  & \\ 
%DIFDELCMD < 2    & 3.5 $\times$ 450 & 0.15  &   3   & 0.2  &   5  & \\ 
%DIFDELCMD < 5    & 3 $\times$ 450 & 0.15  &   2     & 0.3  &   5  & \\ 
%DIFDELCMD < 10   & 3 $\times$ 500 & 0.1  &   2      & 0.3  &   5  & \\ 
%DIFDELCMD < 22   & 2.5 $\times$ 400 & 0.1  &   2    & 0.2  &   5  & \\ 
%DIFDELCMD < 46   & 2.5 $\times$ 350 & 0.06  &   3   & 0.2  &   8  & \\ 
%DIFDELCMD < 68   & 2.5 $\times$ 350 & 0.04 & 3--10  & 0.05 & 3--10 & \\ 
%DIFDELCMD < 100  & 3 $\times$ 300 & 0.03 & 15--25 & \multicolumn{2}{c}{$\left[0.05 +5\%\right]$} \\ 
%DIFDELCMD < 150  & 3 $\times$ 400 & 0.02 & 5--70 & \multicolumn{2}{c}{$\left[0.02 +5\%\right]$} \\ 
%DIFDELCMD < 215  & 3.5 $\times$ 350   & 0.02 & 5--100 & \multicolumn{2}{c}{$\left[0.02 +20\%\right]$}  \\ 
%DIFDELCMD < 261  & 3.5 $\times$ 400   & 0.03 & 5--100 & ---  & ---   &  Requires further evaluation  \\ 
%DIFDELCMD < 316  & 2.5 $\times$ 550 & 0.03 & ---    & ---  & ---   & Not recommended (until further evaluation) \\ 
%DIFDELCMD < 1000\,--\,464 & ---     & ---  & ---    & ---  & ---   & Not retrieved \\ 
%DIFDELCMD < \bottomrule 
%DIFDELCMD < \end{tabular} 
%DIFDELCMD < \end{minipage} 
...
\caption{\DIFaddFL{Summary for MLS ozone}}\vspace{0.5ex} 
\label{tab:O3Summary} 
\begin{minipage}{\linewidth}\small 
\centering\begin{tabular}{ccccccl}
\toprule 
\parbox[m]{15mm}{\centering\textbf{\DIFaddFL{Pressure / hPa}}} & 
\parbox[m]{24mm}{\centering\textbf{\DIFaddFL{Resolution}\\ \DIFaddFL{Vert. $\times$ Horiz.}}}
&
...
\multicolumn{2}{c}{\parbox[m]{20mm}{\centering\textbf{Accuracy\footnote{%
        ...
        characterization tests.  Stratospheric values are expressed in
        ppmv with a typical \emph{equivalent} percentage value quoted.
        261\,--\,100\,hPa accuracies are the sum of the ppmv \emph{and
          percentage} uncertainties; the ppmv terms arise from observed
        average positive biases in the MLS values relative to tropical
        sonde data (from 2005 through 2015).  }%
      \\ppmv\hfill\%}}}
& \textbf{\DIFaddFL{Comments}} \\
\midrule
\DIFaddFL{$\leq$ 0.01 }& \DIFaddFL{---            }& \DIFaddFL{---  }& \DIFaddFL{---    }& \DIFaddFL{---  }& \DIFaddFL{---  }& \DIFaddFL{Unsuitable for scientific use }\\
\DIFaddFL{0.02 }& \DIFaddFL{5.5 $\times$ 200 }& \DIFaddFL{1.2  }& \DIFaddFL{300    }& \DIFaddFL{0.2  }&  \DIFaddFL{50   }& \\
\DIFaddFL{0.05 }& \DIFaddFL{5.5 $\times$ 200 }& \DIFaddFL{0.8  }& \DIFaddFL{150    }& \DIFaddFL{0.2  }&  \DIFaddFL{30   }& \\
\DIFaddFL{0.1  }& \DIFaddFL{4 $\times$ 400   }& \DIFaddFL{0.5  }&  \DIFaddFL{60    }& \DIFaddFL{0.2  }&  \DIFaddFL{20   }& \\
\DIFaddFL{0.2  }& \DIFaddFL{3 $\times$ 450   }& \DIFaddFL{0.4  }&  \DIFaddFL{30    }& \DIFaddFL{0.15 }&  \DIFaddFL{10   }& \\
\DIFaddFL{0.5  }& \DIFaddFL{3.5 $\times$ 550 }& \DIFaddFL{0.3  }&  \DIFaddFL{20    }& \DIFaddFL{0.2  }&  \DIFaddFL{10   }& \\
\DIFaddFL{1    }& \DIFaddFL{3 $\times$ 500   }& \DIFaddFL{0.2  }&  \DIFaddFL{7     }& \DIFaddFL{0.3  }&  \DIFaddFL{10   }& \\
\DIFaddFL{2    }& \DIFaddFL{3.5 $\times$ 450 }& \DIFaddFL{0.15 }&   \DIFaddFL{3    }& \DIFaddFL{0.3  }&   \DIFaddFL{7   }& \\
\DIFaddFL{5    }& \DIFaddFL{3 $\times$ 450   }& \DIFaddFL{0.15 }&   \DIFaddFL{2    }& \DIFaddFL{0.4  }&   \DIFaddFL{7   }& \\
\DIFaddFL{10   }& \DIFaddFL{3 $\times$ 500   }& \DIFaddFL{0.1  }&   \DIFaddFL{2    }& \DIFaddFL{0.4  }&   \DIFaddFL{6   }& \\
\DIFaddFL{22   }& \DIFaddFL{2.5 $\times$ 400 }& \DIFaddFL{0.1  }&   \DIFaddFL{2    }& \DIFaddFL{0.25 }&   \DIFaddFL{5   }& \\
\DIFaddFL{46   }& \DIFaddFL{2.5 $\times$ 350 }& \DIFaddFL{0.06 }&   \DIFaddFL{3    }& \DIFaddFL{0.2  }&   \DIFaddFL{8   }& \\
\DIFaddFL{68   }& \DIFaddFL{2.5 $\times$ 350 }& \DIFaddFL{0.04 }&   \DIFaddFL{4    }& \DIFaddFL{0.1  }&   \DIFaddFL{7   }& \\
\DIFaddFL{100  }& \DIFaddFL{3 $\times$ 300   }& \DIFaddFL{0.03 }& \DIFaddFL{15--25 }& \multicolumn{2}{c}{$\left[+0.005 +7\%\right]$}  \\
\DIFaddFL{150  }& \DIFaddFL{3 $\times$ 400   }& \DIFaddFL{0.02 }& \DIFaddFL{5--70  }&  \multicolumn{2}{c}{$\left[+0.005 +7\%\right]$} \\
\DIFaddFL{215  }& \DIFaddFL{3.5 $\times$ 350 }& \DIFaddFL{0.02 }& \DIFaddFL{5--100 }& \multicolumn{2}{c}{$\left[+0.01 +10\%\right]$} \\
\DIFaddFL{261 }& \DIFaddFL{3.5 $\times$ 400 }& \DIFaddFL{0.03 }& \DIFaddFL{5--100 }&
\multicolumn{2}{c}{$\left[+0.02 +10\%\right]$} & \DIFaddFL{See note
}\footnote{\DIFaddFL{Positive bias in the UT,
  but the mean annual variation is nevertheless well behaved
  versus tropical sonde data.}}\\
\DIFaddFL{316  }& \DIFaddFL{2.5 $\times$ 550 }& \DIFaddFL{0.03 }& \DIFaddFL{---    }& \DIFaddFL{---  }& \DIFaddFL{---   }& \DIFaddFL{Not recommended }\\
\DIFaddFL{1000\,--\,464 }& \DIFaddFL{---     }& \DIFaddFL{---  }& \DIFaddFL{---    }& \DIFaddFL{---  }& \DIFaddFL{---   }& \DIFaddFL{Not retrieved }\\
\bottomrule
\end{tabular} 
\end{minipage} 
\end{table} 
...
\DIFdelbegin \DIFdel{Note that the systematic
uncertainties are from }%DIFDELCMD < \prevv%%%
\DIFdel{, but are not expected to change significantly
in }%DIFDELCMD < \thisv%%%
\DIFdel{.
}\DIFdelend 
...
of the maximum reasonable uncertainty based on instrument knowledge
and/or design requirements}\DIFaddend .These accuracy calculations \DIFdelbegin \DIFdel{are }\DIFdelend \DIFaddbegin \DIFadd{were performed
with more realistic OH atmospheric profiles than }\DIFaddend for \prevv
\DIFdelbegin \DIFdel{products. While
no significant change is expected from }%DIFDELCMD < \prevv %%%
\DIFdel{to }%DIFDELCMD < \thisv%%%
\DIFdel{, a comprehensive
error analysis for }%DIFDELCMD < \thisv %%%
\DIFdel{will be conducted.  Bias uncertainty }\DIFdelend \DIFaddbegin \DIFadd{estimates. Biases }\DIFaddend can be eliminated by taking day-night differences from
32\,--\,21\,hPa. For 15\,--\,0.1\,hPa, the observed night OH
concentration is small and day-night differencing is not ordinarily
needed. The \DIFdelbegin \DIFdel{accuracy of the OH
measurement due to systematic errors is a product of scaling uncertainty
and the observed OH concentration. The }\DIFdelend overall uncertainty is the square root of the sum of squares
...
\standardprecisionrule
\evenstatusrule
\item[Quality:] \DIFdelbegin %DIFDELCMD < \screeningrule{MLS \thisv HO\cs2 data can be used
%DIFDELCMD <     irrespective of the value of the \texttt{Quality} field.}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \screeningrule{MLS \thisv OH data can be used
    irrespective of the value of the \texttt{Quality} field.}
\DIFaddend \item[Convergence:] \convergencerule{1.1}
\end{description}
...
\centering\DIFdelbeginFL %DIFDELCMD < \begin{tabular}{rccccl}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \begin{tabular}{rcccl}
\DIFaddendFL \toprule
\textbf{Pressure} &
...
\parbox{5em}{\bfseries\centering \DIFdelbeginFL \DIFdelFL{Bias uncertainty }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Accuracy }\DIFaddendFL / 10\cp6 cm\cp{$-$3}} &
\DIFdelbeginFL \parbox{5em}{%DIFDELCMD < \bfseries\centering %%%
\DIFdelFL{Scaling uncertainty /\%}} %DIFAUXCMD
%DIFDELCMD < &
%DIFDELCMD < %%%
\DIFdelendFL \textbf{Comments}\\
\midrule
$<$0.003\,hPa     & ---                  & ---                  & ---   &  \DIFdelbeginFL \DIFdelFL{--- }%DIFDELCMD < & %%%
\DIFdelendFL Unsuitable for scientific use\\
0.003\,hPa        & 5.0 $\times$ 220     & 0.5 / 0.5            & \DIFdelbeginFL \DIFdelFL{0.034 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.5 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{90  }%DIFDELCMD < &%%%
\DIFdelendFL \\
0.01 \,hPa        & 2.5 $\times$ 180     & 1.1 /1.1             & \DIFdelbeginFL \DIFdelFL{0.031 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2   }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{41  }%DIFDELCMD < &%%%
\DIFdelendFL \\
0.1\,hPa          & 2.5 $\times$ 165     & 3.3 / 0.6            & \DIFdelbeginFL \DIFdelFL{0.12  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{1.0  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{3.1 }%DIFDELCMD < &%%%
\DIFdelendFL \\
1.0\,hPa          & 2.5 $\times$ 165     & 1.9 / 0.4            & \DIFdelbeginFL \DIFdelFL{0.50  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{1.0  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{7   }%DIFDELCMD < &%%%
\DIFdelendFL \\
10 \,hPa          & 2.5 $\times$ 165     & 2.3 / 1.4            & \DIFdelbeginFL \DIFdelFL{0.18  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.9  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{1.5 }%DIFDELCMD < &%%%
\DIFdelendFL \\
32\,--\,14\,hPa   & 2.5 $\times$ 165     & 6\,--\,10 / 4\,--\,8 & \DIFdelbeginFL \DIFdelFL{0.50  }%DIFDELCMD < & %%%
\DIFdelendFL 1.3  & Use day--night difference \\
$>$32\,hPa        & ---                  & ---                  & ---   & \DIFdelbeginFL \DIFdelFL{--- }%DIFDELCMD < & %%%
\DIFdelendFL Unsuitable for scientific use\\
\bottomrule
\end{tabular}
\end{minipage}
...
more details.
\DIFdelbegin \DIFdel{These may change for the v4 RHi product. The MLS team
...
\DIFaddbegin \DIFadd{Also, users should note the possibility of a potential drift in the MLS
lower stratospheric water vapor product, discussed in
section~\ref{sec:H2ODrift}.  Such a drift will also impact the RHi
product.
}

\DIFaddend \subsection*{Review of comparisons with other datasets}
...
injections. Validation of SO\cs2 is published in \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citet{PumphreyEtal14}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet{PumphreyEtal15}}%DIFAUXCMD
}\DIFaddend .
...
\DIFdelbegin \DIFdel{The values for accuracy are based on the v3 systematic error analysis
performed on the MLS measurement system \mbox{%DIFAUXCMD
\citep{ReadEtal07}}%DIFAUXCMD
. The accuracy
}\DIFdelend \DIFaddbegin \DIFadd{Accuracy }\DIFaddend is estimated to be \DIFdelbegin \DIFdel{\texttildelow5}\DIFdelend \DIFaddbegin \DIFadd{10}\DIFaddend \,\DIFaddbegin \DIFadd{--\,15\,}\DIFaddend ppbv for pressures less than
147\,hPa increasing to \texttildelow20\,ppbv at 215\,hPa. These may be
different for the v4 SO\cs2 product.
\DIFdelbegin \DIFdel{The MLS team plans to repeat the v3 exercise
...
\parbox[m]{8em}{\bfseries\centering Single profile precision \DIFaddbeginFL \DIFaddFL{\ ppbv}\DIFaddendFL } &
\parbox[m]{6em}{\bfseries\centering Accuracy / ppbv} &
\bfseries Comments \\
\midrule
$<$ 10 & --- & --- & --- &  Unsuitable for scientific use \\
10 & 3.1 $\times$ 165 &  \DIFdelbeginFL \DIFdelFL{4.5 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4.3 }\DIFaddendFL &  \DIFdelbeginFL \DIFdelFL{6  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{16 }\DIFaddendFL & \\
15 & 3.1 $\times$ 171 &  \DIFdelbeginFL \DIFdelFL{5.0 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4.3 }\DIFaddendFL &  \DIFdelbeginFL \DIFdelFL{3  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{12 }\DIFaddendFL & \\
22 & 3.1 $\times$ 171 &  \DIFdelbeginFL \DIFdelFL{4.4 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.9 }\DIFaddendFL &  \DIFdelbeginFL \DIFdelFL{4  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{17 }\DIFaddendFL & \\
32 & 3.0 $\times$ 176 &  \DIFdelbeginFL \DIFdelFL{3.8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.4 }\DIFaddendFL &  \DIFdelbeginFL \DIFdelFL{5  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{14 }\DIFaddendFL & \\
46 & 2.9 $\times$ 176 &  \DIFdelbeginFL \DIFdelFL{3.5 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.2 }\DIFaddendFL &  \DIFdelbeginFL \DIFdelFL{5  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{12 }\DIFaddendFL & \\
68 & 2.9 $\times$ 183 &  \DIFdelbeginFL \DIFdelFL{3.3 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.2 }\DIFaddendFL &  \DIFdelbeginFL \DIFdelFL{6  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{10 }\DIFaddendFL & \\
100 & 2.8 $\times$ 180 &  \DIFdelbeginFL \DIFdelFL{3.2 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.1 }\DIFaddendFL &  \DIFdelbeginFL \DIFdelFL{6  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{10 }\DIFaddendFL & \\
147 & 2.8 $\times$ 180 &  \DIFdelbeginFL \DIFdelFL{2.5 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.2 }\DIFaddendFL &  10 & \\
215 & 3.5 $\times$ 186 &  \DIFdelbeginFL \DIFdelFL{3.5 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.8 }\DIFaddendFL &  20 & \\
...
A substantial study \DIFaddbegin \DIFadd{has been made }\DIFaddend of sources of systematic error in MLS
\DIFdelbegin \DIFdel{measurements
}\DIFdelend \DIFaddbegin \thisv \DIFadd{measurements, similar to that which }\DIFaddend was done as a part of the
validation of v2.2\DIFdelbegin \DIFdel{, and as the measurement
system is substantially unchanged, those results are repeated here}\DIFdelend . The accuracy of the \DIFdelbegin \DIFdel{v2.2 temperature measurements
was }\DIFdelend \DIFaddbegin \thisv \DIFadd{temperature measurements
is }\DIFaddend estimated both by modeling the impact of uncertainties in measurement
and retrieval parameters that could lead to systematic errors, and
through comparisons with correlative data sets.  Column~5 of
...
found that it did not close \DIFdelbegin \DIFdel{forword }\DIFdelend \DIFaddbegin \DIFadd{forward }\DIFaddend model and measured radiances as
...
predicted vertical structure is \DIFdelbegin \DIFdel{very }\DIFdelend similar to observed biases relative
...
The last four profiles of each day show increased rates of outliers
relative to GEOS-5 temperature, compared to other profile positions in
the day in version~4.20 (\DIFaddbegin \DIFadd{the problem is }\DIFaddend fixed in version~4.22).  These outliers can be
as large as 50\,K at at some levels.  A recommendation to discard the
last 4 profiles of each day has been added to recommended screening for
v4.20 (not needed for v4.22 \DIFaddbegin \DIFadd{and later versions}\DIFaddend ).
...
version~5~\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{ReineckerEtal07} }%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{RieneckerEtal07} }%DIFAUXCMD
}\DIFaddend (GEOS-5), the European Center for
...
\parbox[m]{6em}{\centering\DIFdelbegin \textbf{\DIFdel{Modeled Bias}%DIFDELCMD < \\%%%
\DIFdel{uncertainty}%DIFDELCMD < \\ %%%
\DIFdel{/ K}}%DIFAUXCMD
\DIFdelend \DIFaddbegin \textbf{\DIFadd{Modeled}\\\DIFadd{accuracy}\\ \DIFadd{/ K}}\DIFaddend } &
\parbox[m]{6em}{\centering\DIFdelbegin \textbf{\DIFdel{Observed Bias}%DIFDELCMD < \\%%%
\DIFdel{uncertainty}%DIFDELCMD < \\ %%%
\DIFdel{/ K}}%DIFAUXCMD
\DIFdelend \DIFaddbegin \textbf{\DIFadd{Observed}\\\DIFadd{accuracy}\\ \DIFadd{/ K}}\DIFaddend } &
\textbf{Comments} \\
\midrule
$<$0.001\,hPa      & ---       & ---       &  ---             & --- & --- & Unsuitable for scientific use \\
0.001\,hPa         & $\pm$3.6  & $\pm$3.5   & \DIFdelbegin \DIFdel{11--14 }\DIFdelend \DIFaddbegin \DIFadd{13--14 }\DIFaddend $\times$ \DIFdelbegin \DIFdel{280 }\DIFdelend \DIFaddbegin \DIFadd{290 }\DIFaddend & $+$2\,$\pm$\,\DIFdelbegin \DIFdel{3    }\DIFdelend \DIFaddbegin \DIFadd{1      }\DIFaddend & $-$9     & \\
0.01\,hPa          & $\pm$3.3  & $\pm$3     & 10--11 $\times$ 260 & $+$2\,$\pm$\,\DIFdelbegin \DIFdel{3    }\DIFdelend \DIFaddbegin \DIFadd{1      }\DIFaddend & $-$2\,to\,0 & \\
0.1\,hPa           & $\pm$2.4  & $\pm$2.7   & 6      $\times$ 170 & $+$\DIFdelbegin \DIFdel{2}\DIFdelend \DIFaddbegin \DIFadd{3}\DIFaddend \,$\pm$\,\DIFdelbegin \DIFdel{2    }\DIFdelend \DIFaddbegin \DIFadd{1.2    }\DIFaddend & $-$8\,to\,0 & \\
0.316\,hPa         & $\pm$1.3  & $\pm$1.5   & 8      $\times$ 170 & $+$\DIFdelbegin \DIFdel{3}\DIFdelend \DIFaddbegin \DIFadd{2}\DIFaddend \,$\pm$\,\DIFdelbegin \DIFdel{2    }\DIFdelend \DIFaddbegin \DIFadd{0.8    }\DIFaddend & $-$7\,to\,$-$4& \\
1\,hPa             & $\pm$1.2  & $\pm$1.3   & 6.8    $\times$ 165 & $+$1\,$\pm$\,\DIFdelbegin \DIFdel{2    }\DIFdelend \DIFaddbegin \DIFadd{0.5    }\DIFaddend &  0\,to\,$+$5 & \\
3.16\,hPa          & $\pm$0.8  & $\pm$0.8   & 5.5    $\times$ 165 & $+$2\,$\pm$\,\DIFdelbegin \DIFdel{2    }\DIFdelend \DIFaddbegin \DIFadd{1.2    }\DIFaddend & $+$1 & \\
10\,hPa            & $\pm$0.6  & $\pm$0.7   & 4.1    $\times$ 165 & \DIFdelbegin \DIFdel{0}\DIFdelend \DIFaddbegin \DIFadd{$-$1}\DIFaddend \,$\pm$\,\DIFdelbegin \DIFdel{2      }\DIFdelend \DIFaddbegin \DIFadd{0.5      }\DIFaddend & $-$1\,to\,0& \\
14.7\,hPa          & $\pm$0.6  & $\pm$0.7   & 3.9    $\times$ 165 & $+$\DIFdelbegin \DIFdel{4}\DIFdelend \DIFaddbegin \DIFadd{2.7}\DIFaddend \,$\pm$\,\DIFdelbegin \DIFdel{2    }\DIFdelend \DIFaddbegin \DIFadd{0.9    }\DIFaddend &  0\,to\,$+$1 & \\
31.6\,hPa          & $\pm$\DIFdelbegin \DIFdel{0.5  }\DIFdelend \DIFaddbegin \DIFadd{0.6  }\DIFaddend & $\pm$0.6   & 3.6    $\times$ 165 & $+$\DIFdelbegin \DIFdel{1}\DIFdelend \DIFaddbegin \DIFadd{0.7}\DIFaddend \,$\pm$\,\DIFdelbegin \DIFdel{2    }\DIFdelend \DIFaddbegin \DIFadd{0.7    }\DIFaddend & $-$2\,to\,0 & \\
56.2\,hPa          & $\pm$0.6  & $\pm$0.7   & \DIFdelbegin \DIFdel{3.8 }\DIFdelend \DIFaddbegin \DIFadd{3.7    }\DIFaddend $\times$ 165 & $-$\DIFdelbegin \DIFdel{1}\DIFdelend \DIFaddbegin \DIFadd{1.5}\DIFaddend \,$\pm$\,\DIFdelbegin \DIFdel{2    }\DIFdelend \DIFaddbegin \DIFadd{0.8    }\DIFaddend & $-$2\,to\,0 & \\
100\,hPa           & $\pm$0.7  & $\pm$1.0   & \DIFdelbegin \DIFdel{4.6 }\DIFdelend \DIFaddbegin \DIFadd{4.7    }\DIFaddend $\times$ 165 & $+$\DIFdelbegin \DIFdel{2}\DIFdelend \DIFaddbegin \DIFadd{1.8}\DIFaddend \,$\pm$\,\DIFdelbegin \DIFdel{2    }\DIFdelend \DIFaddbegin \DIFadd{1.2    }\DIFaddend &  0\,to\,$+$1  & \\
215\,hPa           & $\pm$0.8  & $\pm$1.2   & \DIFdelbegin \DIFdel{3.5 }\DIFdelend \DIFaddbegin \DIFadd{4.2    }\DIFaddend $\times$ 165 & $-$\DIFdelbegin \DIFdel{1.5}\DIFdelend \DIFaddbegin \DIFadd{0.8}\DIFaddend \,$\pm$\,\DIFdelbegin \DIFdel{4 }\DIFdelend \DIFaddbegin \DIFadd{1.4 }\DIFaddend & $-$2.5\,to\,$-$1.5   & \\
261\,hPa           & $\pm$0.7  & $\pm$1.5   & \DIFdelbegin \DIFdel{4.0 }\DIFdelend \DIFaddbegin \DIFadd{4.2    }\DIFaddend $\times$ 167 & \DIFdelbegin \DIFdel{0}\DIFdelend \DIFaddbegin \DIFadd{0.4}\DIFaddend \,$\pm$\,\DIFdelbegin \DIFdel{5      }\DIFdelend \DIFaddbegin \DIFadd{2.4      }\DIFaddend & $-$2\,to\,0   & \\
1000\,--\,316\,hPa & ---       & ---      & ---              & ---           & --- & Unsuitable for scientific use\\
\bottomrule
\end{tabular}
\end{minipage}
...
%DIF >  \begin{sidewaystable}
%DIF >  \caption{Summary of MLS Temperature product}\vspace{0.5ex}
%DIF >  \label{tab:TemperatureSummary}
%DIF >  \begin{minipage}{\textheight}
%DIF >  \centering\begin{tabular}{ccccccl}
%DIF >  \toprule
%DIF >  \textbf{Pressure} & 
%DIF >  \parbox[m]{4.5em}{\centering\textbf{Precision\footnote{Precision on individual profiles} \\/ K}} &
%DIF >  \parbox[m]{4em}{\centering\textbf{Observed Scatter\footnote{Precision
%DIF >        inferred from differences of
%DIF >        individual profiles from successive orbits (v2.2 results shown)} \\/ K}} &
%DIF >  \parbox[m]{4.5em}{\centering\textbf{Resolution\\ V $\times$ H\\ / km}} &
%DIF >  \parbox[m]{6em}{\centering\textbf{Modeled Bias\\uncertainty\\ / K}} &
%DIF >  \parbox[m]{6em}{\centering\textbf{Observed Bias\\uncertainty\\ / K}} &
%DIF >  \textbf{Comments} \\
%DIF >  \midrule
%DIF >  $<$0.001\,hPa      & ---       & ---       &  ---             & --- & --- & Unsuitable for scientific use \\
%DIF >  0.001\,hPa         & $\pm$3.6  & $\pm$3.5   & 13--14 $\times$ 290 & $+$2\,$\pm$\,3    & $-$9     & \\
%DIF >  0.01\,hPa          & $\pm$3.3  & $\pm$3     & 10--11 $\times$ 260 & $+$2\,$\pm$\,3    & $-$2\,to\,0 & \\
%DIF >  0.1\,hPa           & $\pm$2.4  & $\pm$2.7   & 6      $\times$ 170 & $+$2\,$\pm$\,2    & $-$8\,to\,0 & \\
%DIF >  0.316\,hPa         & $\pm$1.3  & $\pm$1.5   & 8      $\times$ 170 & $+$3\,$\pm$\,2    & $-$7\,to\,$-$4& \\
%DIF >  1\,hPa             & $\pm$1.2  & $\pm$1.3   & 6.8    $\times$ 165 & $+$1\,$\pm$\,2    &  0\,to\,$+$5 & \\
%DIF >  3.16\,hPa          & $\pm$0.8  & $\pm$0.8   & 5.5    $\times$ 165 & $+$2\,$\pm$\,2    & $+$1 & \\
%DIF >  10\,hPa            & $\pm$0.6  & $\pm$0.7   & 4.1    $\times$ 165 &  0\,$\pm$\,2      & $-$1\,to\,0& \\
%DIF >  14.7\,hPa          & $\pm$0.6  & $\pm$0.7   & 3.9    $\times$ 165 & $+$4\,$\pm$\,2    &  0\,to\,$+$1 & \\
%DIF >  31.6\,hPa          & $\pm$0.6  & $\pm$0.6   & 3.6    $\times$ 165 & $+$1\,$\pm$\,2    & $-$2\,to\,0 & \\
%DIF >  56.2\,hPa          & $\pm$0.6  & $\pm$0.7   & 3.7    $\times$ 165 & $-$1\,$\pm$\,2    & $-$2\,to\,0 & \\
%DIF >  100\,hPa           & $\pm$0.7  & $\pm$1.0   & 4.7    $\times$ 165 & $+$2\,$\pm$\,2    &  0\,to\,$+$1  & \\
%DIF >  215\,hPa           & $\pm$0.8  & $\pm$1.2   & 4.2    $\times$ 165 &  $-$1.5\,$\pm$\,4 & $-$2.5\,to\,$-$1.5   & \\
%DIF >  261\,hPa           & $\pm$0.7  & $\pm$1.5   & 4.2    $\times$ 167 &  0\,$\pm$\,5      & $-$2\,to\,0   & \\
%DIF >  1000\,--\,316\,hPa & ---       & ---      & ---              & ---           & --- & Unsuitable for scientific use\\
%DIF >  \bottomrule
%DIF >  \end{tabular}
%DIF >  \end{minipage}
...
\renewcommand{\currentnav}{BLANK}
%
\DIFaddbegin \rhead{\large\sffamily\textcolor{HeaderFooterColor}{\nouppercase{\rightmark}}}
\DIFaddend \renewcommand{\leftmark}{Bibliography}
