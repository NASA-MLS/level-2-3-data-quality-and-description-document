...
\usepackage[lf,sb]{libertine}
\renewcommand{\mytexttilde}{\textasciimytexttilde}
% Also use libertine in any equations we have
\usepackage[libertine]{newtxmath}
%
% For sans serif we'll use the Deja Vu Sans condensed family (it's a bit
% heavier than I would have liked but other fonts had less manageable quirks).
\usepackage[scaled=0.8]{DejaVuSansCondensed}
...
\colorlet{ChapterTabBackgroundA}{ChapterColor!20}
\colorlet{ChapterTabBackgroundB}{ChapterColor!30}
\colorlet{SectionColor}{SeaGreen!80!black}% 
\colorlet{SectionBackground}{SectionColor!20}
\colorlet{SectionTabBackgroundA}{SectionColor!15}
\colorlet{SectionTabBackgroundB}{SectionColor!25}
