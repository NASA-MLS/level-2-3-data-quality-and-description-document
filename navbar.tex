...
\newcommand{\DrawNavBarProduct}[2]{%
  ...
  % #2 is the name for it (e.g., \ce{H2O})
  ...
  \savebox{\navbar}{%
    \begin{tikzpicture}
      \matrix[row sep=0pt, inner sep=0pt, outer sep=0pt] {
        ...
        \node {\DrawNavBarProduct{CH3Cl}{\ce{CH3Cl}}};\\
        \node {\DrawNavBarProduct{CH3CN}{\ce{CH3CN}}};\\
        \node {\DrawNavBarProduct{CH3OH}{\ce{CH3OH}}};\\
        \node {\DrawNavBarProduct{ClO}{ClO}};\\
        \node {\DrawNavBarProduct{CO}{CO}};\\
        \node {\DrawNavBarProduct{GPH}{GPH}};\\
        \node {\DrawNavBarProduct{H2O}{\ce{H2O}}};\\
        \node {\DrawNavBarProduct{HCl}{HCl}};\\
        \node {\DrawNavBarProduct{HCN}{HCN}};\\
        \node {\DrawNavBarProduct{HNO3}{\ce{HNO3}}};\\
        \node {\DrawNavBarProduct{HO2}{\ce{HO2}}};\\
        \node {\DrawNavBarProduct{HOCl}{HOCl}};\\
        \node {\DrawNavBarProduct{IWC}{IWC}};\\
        \node {\DrawNavBarProduct{IWP}{IWP}};\\
        \node {\DrawNavBarProduct{N2O}{\ce{N2O}}};\\
        \node {\DrawNavBarProduct{O3}{\ce{O3}}};\\
