...
particularly in the summer hemisphere (or tropics when near the equinox)
and sometimes causes gaps in zonal mean time series. The \thisv software
...
257 and the profile is ignored. This can present a problem when
