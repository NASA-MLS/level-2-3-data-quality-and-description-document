...
improvements in v4.x inherited to \thisv. Previous to v3.x, OH data near the mesospheric density peak,
...
\caption{Zonal mean of retrieved OH and its estimated precision
  ...
  \thisv OH vmr vs. pressure for day (black) and night (blue). The 
  ...
  are equivalent to (a) and (c) but using \prevv OH  data.}
...
\citet{WangEtal:2008}.  The comparison among v2.2 and \thisv show
