...
errors for an earlier version, v2.2, is given in
...
show considerable amount of bad data due to negative precision,
particularly in the summer hemisphere (or tropics when near equinox) and
sometimes causes gaps in zonal mean time series. The \thisv software
resolves this issue by fixing the too tight a priori constraints. The
resulting mesospheric OH data are less noisy and generally have somewhat
larger values than previous versions for the problematic
seasons/latitudes. Another improvement is the smaller bias at
10\,--\,15\,hPa. Therefore, the day-night correction for bias is only
...
profiles. This is a side effect when fixing the possible positive bias
...
eliminated by taking day-night differences from 32\,--\,14\,hPa. For
