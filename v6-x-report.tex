...
% --------------------------------------- Colors
%
% \definecolor{ThemeA}{HTML}{03254e}
% \definecolor{ThemeB}{HTML}{a23e48}
\colorlet{ThemeA}{DarkTurquoise}
\colorlet{ThemeB}{Coral}
...
\newcommand{\CheckThis}{{\small\sffamily\color{DarkOrange}[\textsl{Check this}]}}
%
...
%
\title{Version~5.0x Level~2 and~3 data quality and description document.}
\author{%
Nathaniel~J.~Livesey,
William~G.~Read,
Paul~A.~Wagner,
