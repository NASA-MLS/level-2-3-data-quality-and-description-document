...
\begin{itemize}
  ...
  \item Retrieved profiles are rather jagged, especially between 1\,hPa (48\,km) and 0.1\,hPa (64\,km). The greater smoothing applied in \thisv, \prevv, \viv and v03.3 compared to v2.2 reduced this problem considerably but has not eliminated it entirely.
...
In the upper troposphere, comparisons with various in situ CO observations (NASA DC-8, WB-57 and the MOZAIC dataset) indicate that the \emph{earlier} MLS v2.2 215\,hPa CO product was biased high by a factor of \mytexttilde2. As in \viv and \prevv, this bias is largely eliminated in \thisv.
