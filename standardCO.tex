...
recommended for \prevv results in a significant amount of missing data
in the tropics, and when the recommended IWC-based component of \prevv
...
\item[Quality:] \screeningrule{Only use profiles with \texttt{Quality}
  ...
  mixing ratios that are, on average, 12\% higher than other tropical
  ...
  ensemble.  At 147\,hPa and 100\,hPa the rejected profiles are
...
\item As discussed above, the \thisv CO retrievals are sensitive to the
  ...
  based on \texttt{Status}, \texttt{Quality} and \texttt{Convergence}
...
of \texttildelow2. Initial comparisons show this bias to be largely
...
may mostly be considered valid for \thisv. What change there is consists
of a slight lowering of the MLS values, bringing them slightly towards
the ACE-FTS data; 20\% is now a better estimate than 30\% of the MLS-ACE
bias in much of the middle atmosphere.
