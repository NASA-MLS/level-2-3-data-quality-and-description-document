...
and \prevv CO is the reduction in the frequency and severity of
...
very similar to that of \prevv and is usually smaller (better) than
...
the ACE-FTS instrument; see \citet{PumphreyEtal:2007} for further details.
...
generally realistic \citep{LiveseyEtal:2008}.  In \thisv (as in
\prevv) this bias has been essentially eliminated through a change
...
\item Retrieved profiles are rather jagged, especially between 1\,hPa
  ...
  \thisv (and \prevv) compared to v2.2 has reduced this problem
...
\item There is a tendency for negative values to occur at the level
  ...
  \prevv than in v2.2 -- this was considered an acceptable
...
(compared to 30\% with v2.2). The difference between \prevv and
