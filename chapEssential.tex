...
\item[Partial amelioration of drifts in 190-GHz products (H\cs2O,
  N\cs2O, HCN):] STUFF
\item[Correction of dry bias in upper tropospheric H\cs2O:] STUFF
\item[Extension of N\cs2O product to 100\,hPa:] STUFF
\item[Increased vertical range for some species:] STUFF
  \mycomment{More needed}
\end{description}
