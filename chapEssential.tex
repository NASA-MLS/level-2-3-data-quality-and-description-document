...
shortly. \mycomment{Update python discussion.  From Paul: Tested
  successfully with Python v2.4, but not version 3.0 Returns correct
  data, but issues a warning message for each data variable, due to a
  limitation in the PyTables module}
...
and therefore more trustworthy data. Values of \texttt{Quality} closer to
