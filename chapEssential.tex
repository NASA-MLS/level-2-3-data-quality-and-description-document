...
\end{quote}
where \verb+<case>+ is \verb+Eq+ or \verb+70N+ for the equator and 70\degsym{}N, respectively (or \verb+Day+ and \verb+Night+ for OH, see Section~\ref{sec:StandardOH}).  These are available as a single tar archive from the MLS web site at \url{https://mls.jpl.nasa.gov/eos-aura-mls/data-products/averaging-kernels/}.  \mycomment{Make sure both the 2D and 1D files are available on the MLS website, and that the link is correct.}
