...
A subset of the information in those documents is also reported in the
\emph{IEEE Transactions on Geoscience and Remote Sensing}.  An
...
\item[Partial amelioration of drifts in 190-GHz products (H\cs2O,
  ...
  a rate of between 0.2--1\%/year, depending on what record is it
  compared to (mainly frostpoint sonde or ACE-FTS) and the altitude
  range of interest.  The MLS team has identified a slow change in
  instrument calibration that accounts for some of this drift, and is
  corrected for in \thisv.  The extent to which this correction fully
  accounts for the observed drift remains to be studied as the \thisv
  processing continues.  The calibration trend also affects other
  species measured by the MLS 190-GHz subsystem, notably N\cs2O.
