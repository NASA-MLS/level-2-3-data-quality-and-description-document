...
Validation'' defined\footnote{See
  \url{http://science.nasa.gov/earth-science/earth-science-data/data-maturity-levels/}}
as:
\begin{quote}\itshape
...
Interactive Data Language (IDL, version 6.1 or later required), known
as \texttt{readl2gp.pro} may have been supplied with the data and is
available from the \emph{Open Channel Software Foundation}
\url{http://www.openchannelsoftware.org/}.  A reader for MATLAB
(\texttt{readL2GP.m}) is also available at the same site, and one for
python is in development.
