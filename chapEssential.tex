...
\begin{quote}
\emph{The MLS retrieval algorithms identified some of the radiances in this region as being affected by clouds, and opted not to use them in the retrieval, thus changing the character of the retrieved profiles in some manner that may set it apart from those in ``cloud free'' observations.}\quad(\thisv)
\end{quote}
