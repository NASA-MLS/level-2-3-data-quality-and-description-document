...
the \texttt{HNO3} swath are from the \mbox{240-GHz} radiometer and
...
\item[Convergence:] \convergencerule{1.03}
  ...
  0.1\% of the HNO\cs3 profiles.  Most such profiles show unphysical
  behavior.
...
\item[Clouds:] \screeningrule{Clouds impact HNO\cs3 data in the UTLS,
  ...
  \texttildelow5\% on average in the tropics.  \mycomment{Numbers here
    per Lucien's results, haven't had a chance to check further.}  Clouds
...
\item[Quality:] \screeningrule{Only profiles with a value of the
  ...
  identifying all ``bad'' ones.  Most profiles flagged by low
  \texttt{Quality} do not show obvious unphysical behavior.
...
\caption{HNO\cs3 profiles on 20~Feb~2009 color-coded by screening.  Cyan
  ...
  profiles) after the screening.  The left panels show all individual
