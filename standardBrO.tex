...
artifacts \citep{MillanEtal:2012}, and those products are available from
the GSFC DISC\@.  The product short name is ``\texttt{ML3DZMBRO}'' and
it is available from: \newcommand{\myus}{\rule{1ex}{0.8pt}}
\href{ftp://acdisc.gsfc.nasa.gov/data/s4pa/Aura_MLS_Level3/ML3DZMBRO.003/}%
{\texttt{ftp://acdisc.gsfc.nasa.gov/data/s4pa/Aura\_MLS\_Level3/ML3DZMBRO.004/}}
