\begin{tikzpicture}[remember picture,overlay, inner sep=0pt]
  ...
  \node (PreTitle) [anchor=north west, xshift=1.2in, yshift=-0.8in, text width=6.5in, font=\sffamily\fontseries{m}\fontsize{20pt}{26pt}\selectfont, white] at (current page.north west)
  ...
  \node (Aura) at ($ (current page.south west) + (1.5in, 3.5in) $) {\includegraphics[width=2in]{graphics/Aura-Image.png}};
