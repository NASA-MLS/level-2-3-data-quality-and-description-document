...
improvements from v1.5 to v2.2, the HO\cs2 data quality in \thisv is
generally similar to v2.2 except that \thisv has fewer non-convergent
retrievals and therefore better zonal mean precisions in a given
latitude bin.  The estimated uncertainties, precisions, and resolution
for \thisv HO\cs2 are summarized below in Table~\ref{tab:HO2Summary}. Note
that the systematic uncertainties are from v2.2 and are not expected to
change significantly in \thisv.
...
A typical HO\cs2 profile and the associated precisions (for both v2.2
...
for altitudes above 0.046\,hPa (\texttildelow70\,km). Precisions are such that
an HO\cs2 zonal average within a 10\degsym\ latitude bin can be
determined with better than 10\% relative precision with 20 days of data
(\texttildelow2000 samples) for most pressure levels over 22\,--\,0.046\,hPa.

\oneverticalavk{HO2}{HO\cs2}%

\begin{figure}
\begin{tabular}{@{}l@{}l@{}}
\dontincludegraphics[width=0.5\linewidth]{figures/plot-HO2-sep1-sep30-3052profiles-a}&
\dontincludegraphics[width=0.5\linewidth]{figures/plot-HO2-sep1-sep30-3052profiles-b}\\
\dontincludegraphics[width=0.5\linewidth]{figures/plot-HO2-sep1-sep30-3052profiles-c}&
\dontincludegraphics[width=0.5\linewidth]{figures/plot-HO2-sep1-sep30-3052profiles-d}\\
\dontincludegraphics[width=0.5\linewidth]{figures/plot-HO2-sep1-sep30-2695profiles-e}&
\dontincludegraphics[width=0.5\linewidth]{figures/plot-HO2-sep1-sep30-2695profiles-f}%
\end{tabular}
...
by taking day-night differences over the entire recommended pressure
range. The accuracy of the HO\cs2 measurement due to systematic errors
is a product of scaling uncertainty and the observed HO\cs2
...
given in \citet{PickettEtal08}. The comparison between v2.2 and \thisv
