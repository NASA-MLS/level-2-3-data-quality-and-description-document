...
\citet{ReadEtal:2007}. Table~\ref{tab:RHISummary} is summary of precision,
...
{figures/rhi_grid_maps_jf2005_airsv6-mlsv3andv4.png}
\end{center}
...
\begin{center}
  \includegraphics[width=0.9\linewidth]
{figures/rhi_grid_maps_jja2005_airsv6-mlsv3andv4.png}
\end{center}
\caption{Mapped fields from AIRS v6 (left), MLS v2.2 (center-left), MLS v3.3
(center-right), and MLS v4.2 (right) pressures between 300--150 hPa for
June--August 2005.}
